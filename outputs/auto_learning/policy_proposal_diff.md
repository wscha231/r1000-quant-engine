...
+
+policy_version: "2026-05-alphaops-20260621-v1"
+generated_at: "2026-06-21T02:43:58Z"
...
+evidence_summary:
+  main_cagr: 0.3306595355775701
+  main_sharpe: 1.844916769060813
+  main_max_dd: -0.15841809942309326
+  main_avg_turnover_monthly: 0.5282465399682306
+  main_avg_stock_names: 25.304878048780488
+  concentrated_cagr: 0.5095440569967113
+  concentrated_sharpe: 1.590500881786434
+  concentrated_max_dd: -0.18520078824589115
+  trade_count: 742
+  concentrated_trade_count: 163
+  combined_trade_count: 905
+  combined_win_rate: 0.5502762430939226
+  combined_avg_alpha_vs_benchmark: 0.04812283307893307
+  feature_gate_candidate_count: 5
...
+    ic: -0.0949
+    n: 153
+    rationale: "IC -0.095 in bear (n=153) <= disable threshold -0.05"
+  -
+    kind: "signal_regime_disable"
...
+    ic: -0.1161
+    n: 153
+    rationale: "IC -0.116 in bear (n=153) <= disable threshold -0.05"
+  -
+    kind: "signal_regime_disable"
...
+    ic: -0.1008
+    n: 153
+    rationale: "IC -0.101 in bear (n=153) <= disable threshold -0.05"
+  -
+    kind: "signal_regime_disable"
...
+    ic: -0.0626
+    n: 153
+    rationale: "IC -0.063 in bear (n=153) <= disable threshold -0.05"
+  -
...
+    ic: 0.1113
+    n: 185
+    rationale: "IC +0.111 in bull (n=185) >= amplify threshold +0.1"
+sleeve_policy:
+  main_v2_balanced:
+    deep_bear:
+      core: 0.4
...
+    mandate: "main"
+    current_avg_stock_names: 25.304878048780488
...
+      cash: 0.05
+    evidence:
+      future_latest_multi_year_winner: 2.9610108123681447
+      early_latest_multi_year_winner: 0.5999587824264953
+      core_latest_multi_year_winner: 2.0464736960303838
