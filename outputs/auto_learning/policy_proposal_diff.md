...
+generated_at: "2026-06-21T22:30:42Z"
...
+evidence_summary:
+  main_cagr: 0.34874897692369466
+  main_sharpe: 1.8683127723787383
+  main_max_dd: -0.14775833156669427
+  main_avg_turnover_monthly: 0.5302421559924095
+  main_avg_stock_names: 25.426829268292682
+  concentrated_cagr: 0.5490632646347016
+  concentrated_sharpe: 1.8118870549611277
+  concentrated_max_dd: -0.14701705345254945
+  trade_count: 764
+  concentrated_trade_count: 206
+  combined_trade_count: 970
+  combined_win_rate: 0.5515463917525774
+  combined_avg_alpha_vs_benchmark: 0.047349358210482716
+  feature_gate_candidate_count: 4
...
+    ic: -0.0861
+    n: 153
+    rationale: "IC -0.086 in bear (n=153) <= disable threshold -0.05"
+  -
+    kind: "signal_regime_disable"
...
+    ic: -0.1262
+    n: 153
+    rationale: "IC -0.126 in bear (n=153) <= disable threshold -0.05"
+  -
+    kind: "signal_regime_disable"
...
+    ic: -0.0804
+    n: 153
+    rationale: "IC -0.080 in bear (n=153) <= disable threshold -0.05"
+  -
+    kind: "signal_regime_disable"
...
+    ic: -0.0587
+    n: 153
+    rationale: "IC -0.059 in bear (n=153) <= disable threshold -0.05"
+sleeve_policy:
+  main_v2_balanced:
+    deep_bear:
+      core: 0.4
...
+    mandate: "main"
+    current_avg_stock_names: 25.426829268292682
...
+      cash: 0.05
+    evidence:
+      future_latest_multi_year_winner: 2.9517357830971993
+      early_latest_multi_year_winner: 0.5666896874642091
+      core_latest_multi_year_winner: 2.050399945798033
