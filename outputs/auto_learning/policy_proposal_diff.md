...
+
+policy_version: "2026-05-alphaops-20260622-v1"
+generated_at: "2026-06-22T05:29:53Z"
...
+evidence_summary:
+  main_cagr: 0.3319294293877022
+  main_sharpe: 1.843716696195194
+  main_max_dd: -0.14463034431189148
+  main_avg_turnover_monthly: 0.5361296705318703
+  main_avg_stock_names: 26.0
+  concentrated_cagr: 0.5059777575073019
+  concentrated_sharpe: 1.7433265841651264
+  concentrated_max_dd: -0.1649423408195464
+  trade_count: 769
+  concentrated_trade_count: 203
+  combined_trade_count: 972
+  combined_win_rate: 0.5493827160493827
+  combined_avg_alpha_vs_benchmark: 0.04611601634231337
...
+    ic: -0.1642
+    n: 147
+    rationale: "IC -0.164 in bear (n=147) <= disable threshold -0.05"
+  -
+    kind: "signal_regime_disable"
...
+    ic: -0.1657
+    n: 147
+    rationale: "IC -0.166 in bear (n=147) <= disable threshold -0.05"
+  -
+    kind: "signal_regime_disable"
+    signal: "theme_phase_multiplier_primary"
+    regime: "neutral"
...
+    ic: -0.0617
+    n: 403
+    rationale: "IC -0.062 in neutral (n=403) <= disable threshold -0.05"
+  -
+    kind: "signal_regime_disable"
...
+    ic: -0.1516
+    n: 147
+    rationale: "IC -0.152 in bear (n=147) <= disable threshold -0.05"
+  -
...
+    ic: 0.11
+    n: 403
+    rationale: "IC +0.110 in neutral (n=403) >= amplify threshold +0.1"
+sleeve_policy:
+  main_v2_balanced:
+    deep_bear:
+      core: 0.4
...
+      cash: 0.05
+    evidence:
+      future_latest_multi_year_winner: 2.9517358047999527
+      early_latest_multi_year_winner: 0.5666898271009126
+      core_latest_multi_year_winner: 2.050400083591691
