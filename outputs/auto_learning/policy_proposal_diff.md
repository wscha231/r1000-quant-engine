...
+
+policy_version: "2026-05-alphaops-20260503-v1"
+generated_at: "2026-05-03T19:01:25Z"
...
+    ic: 0.1406
+    n: 138
+    rationale: "IC +0.141 in bear (n=138) >= amplify threshold +0.1"
+  -
+    kind: "signal_regime_amplify"
+    signal: "h1_oversold_value_score"
+    regime: "bear"
+    factor: 1.3
+    ic: 0.119
+    n: 138
+    rationale: "IC +0.119 in bear (n=138) >= amplify threshold +0.1"
+  -
...
+    ic: -0.1191
+    n: 138
+    rationale: "IC -0.119 in bear (n=138) <= disable threshold -0.05"
+  -
+    kind: "signal_regime_disable"
...
+    ic: -0.0874
+    n: 138
+    rationale: "IC -0.087 in bear (n=138) <= disable threshold -0.05"
+sleeve_policy:
+  main_v2_balanced:
+    deep_bear:
+      core: 0.4
...
+    mandate: "main"
+    current_avg_stock_names: 25.50602409638554
...
+      cash: 0.05
+    evidence:
+      future_latest_multi_year_winner: 3.3926623721338043
+      early_latest_multi_year_winner: 0.3457309197385852
+      core_latest_multi_year_winner: 1.534708683933234
