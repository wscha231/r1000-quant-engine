...
class DecisionTests(unittest.TestCase):
    ...
    def test_renderer_changes_get_distinct_executions_and_dirty_engine_never_imports(self):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            cmd = [sys.executable, "tools/run_research_decision_v1.py", "--market-export", "input.json", "--context", "context.json"]
    ...
    def test_previous_metadata_is_sanitized_and_component_schema_is_closed(self):
        ...
        for key, value in (("api_key","dummy"),("extension","https://example.org/a?token=dummy"),("price","not-a-sha256")):
