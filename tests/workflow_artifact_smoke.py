...
def test_daily_operating_selection_refresh_workflow_updates_fresh_data_contract() -> None:
    ...
    for token in [
        ...
        "pre_broker_substrate_gate_status",
        "pre_broker_broker_replay_allowed",
        "pre_broker_blockers",
        "data_freshness_selection_allowed",
        "substrate_selection_allowed",
        "selection_blockers",
        "data_freshness_promotion_allowed",
        "substrate_promotion_gate_pass",
        "production_promotion_allowed",
        "promotion_allowed_scope",
        "universe_health_selection_blocked",
        "pre_broker_substrate_gate_blocked",
        "substrate_recovery",
        "recommended_recovery_source",
        "universe_health_artifact",
        "pre_broker_substrate_gate_artifact",
        "substrate_status_artifacts",
        "review_only",
    ...
    assert '"substrate_promotion_gate_pass": substrate_promotion_gate_pass' in text
