...
def test_workflow_keeps_monthly_books() -> None:
    ...
    for token in (
        ...
        "outputs/main_v3_alpha_concentration/",
        "outputs/main_v3_alpha_concentration_broker_replay/",
        "outputs/concentrated_policy_replay/",
        "outputs/concentrated_v2_challenger/",
        "outputs/concentrated_v2_challenger_broker_replay/",
        "outputs/target_snapshots/",
        "outputs/data_readiness/",
        ...
        "outputs/broker_market_circuit_replay/",
        ...
        "outputs/broker_replacement_swap_replay/",
        "outputs/alpha_selector_broker_grid/",
        "outputs/alpha_selector_market_circuit_grid/",
        "outputs/market_circuit_attribution/",
        "outputs/alpha_selector_dynamic_regime_grid/",
        "outputs/alpha_selector_shadow_drawdown_grid/",
        ...
        "outputs/concentrated_proxy_to_broker_reconciliation/",
...
def test_workflow_runs_latest_diagnostics_sidecars() -> None:
    ...
    for token in [
        ...
        "tools/run_main_v3_alpha_concentration.py",
        "tools/run_concentrated_v2_challenger.py",
        ...
        "tools/run_broker_market_circuit_replay.py",
        "tools/run_broker_market_circuit_grid.py",
        ...
        "tools/run_alpha_selector_market_circuit_grid.py",
        "tools/run_market_circuit_attribution.py",
        "tools/run_concentrated_proxy_to_broker_reconciliation.py",
        "tools/run_alpha_selector_dynamic_regime_grid.py",
        "tools/run_alpha_selector_shadow_drawdown_grid.py",
        ...
        "outputs/full_rebuild_logs/leader_drop_diagnostics.log",
        ...
        "outputs/full_rebuild_logs/position_risk_weekly_validation_main_v3_alpha_concentration.log",
        "outputs/full_rebuild_logs/position_risk_weekly_validation_concentrated.log",
        "outputs/full_rebuild_logs/main_v3_alpha_concentration.log",
        "outputs/full_rebuild_logs/main_v3_alpha_concentration_broker_replay.log",
        "outputs/full_rebuild_logs/concentrated_v2_challenger.log",
        "outputs/full_rebuild_logs/concentrated_v2_challenger_broker_replay.log",
        ...
        "outputs/full_rebuild_logs/broker_market_circuit_replay_main.log",
        "outputs/full_rebuild_logs/broker_market_circuit_replay_concentrated.log",
        ...
        "outputs/full_rebuild_logs/broker_replacement_swap_replay_main.log",
        "outputs/full_rebuild_logs/broker_replacement_swap_replay_concentrated.log",
        "outputs/full_rebuild_logs/alpha_selector_broker_grid_main.log",
        "outputs/full_rebuild_logs/alpha_selector_broker_grid_concentrated.log",
        "outputs/full_rebuild_logs/alpha_selector_market_circuit_grid_main.log",
        "outputs/full_rebuild_logs/alpha_selector_market_circuit_grid_concentrated.log",
        "outputs/full_rebuild_logs/market_circuit_attribution_main.log",
        "outputs/full_rebuild_logs/market_circuit_attribution_concentrated.log",
        "outputs/full_rebuild_logs/concentrated_proxy_to_broker_reconciliation.log",
        "outputs/full_rebuild_logs/alpha_selector_dynamic_regime_grid_main.log",
        "outputs/full_rebuild_logs/alpha_selector_dynamic_regime_grid_concentrated.log",
        "outputs/full_rebuild_logs/alpha_selector_shadow_drawdown_grid_main.log",
        "outputs/full_rebuild_logs/alpha_selector_shadow_drawdown_grid_concentrated.log",
        ...
        "outputs/full_rebuild_logs/cash_policy_reconciliation.log",
        ...
        "outputs/full_rebuild_logs/selection_quality_report.log",
...
def test_free_data_lake_workflow_restores_drive_and_runs_proxy_replay() -> None:
    ...
    for token in [
        ...
        "SAFE_BRANCH",
        "research_runs/${SAFE_BRANCH}/${GITHUB_RUN_ID}/sec_ownership_signals",
...
def test_free_data_daily_workflow_updates_metrics_after_close() -> None:
    ...
    for token in [
        ...
        "outputs/merged_after_close/",
        "outputs/merged_daily_autolearning/",
