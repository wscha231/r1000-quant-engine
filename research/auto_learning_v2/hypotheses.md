...
- Falsify if: maxdd_worsens, cagr_delta_pp < -1.0, bear_trade_loss_rate_spikes

## 2. main_future_alpha_concentration_v1
...
## 4. risk_governor_layered_exit_v1
...
## 5. cluster_conviction_router_v1
...
## 6. alpha_sprint_breakout_fallback_v1
...
## 7. counterfactual_replay_priority_v1
