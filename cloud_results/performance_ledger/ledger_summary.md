...
## Main
- IS-CAGR `19.94%` | state **REGRESSING** | delta prev `-0.53pp` | best `25.36%`
## Concentrated
- IS-CAGR `18.65%` | state **FLAT** | delta prev `-0.14pp` | best `22.41%`
...
| 27957500268 | 8eeb06a | 19.94% | 34.92% | 18.65% | 45.95% | no |
