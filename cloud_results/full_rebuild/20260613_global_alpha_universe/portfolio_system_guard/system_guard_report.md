...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| main | 34.63% | 35.00% | 0.37pp | -26.01% | -25.00% | 1.01pp | false |
| concentrated | 44.80% | 50.00% | 5.20pp | -25.82% | -25.00% | 0.82pp | false |
...
- `main`: severity=`warn`, avg_cash=26.61%, latest_cash=15.95%, reasons=cash_drag_with_cagr_gap
- `concentrated`: severity=`warn`, avg_cash=42.32%, latest_cash=6.62%, reasons=cash_drag_with_cagr_gap
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| main | `main_broker_ledger_replay` | 34.63% | 0.37pp | -26.01% | 1.01pp | false | `blocked_both` |
| concentrated | `concentrated_latest_champion` | 45.81% | 4.19pp | -26.04% | 1.04pp | false | `blocked_both` |
...
- `PASS` sec_enriched_candidate_materialized_for_audit: sec_enriched_candidate_present=True; rows_with_smart_money_evidence=34257
- `PASS` alphaops_vnext_uses_sec_enriched_candidate_book: candidate_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/sec_enriched_candidate_replay/candidate_replay_book_sec_enriched.csv; rows_with_smart_money_evidence=34257
...
- `PASS` main_target_book_reaches_broker_end: selected_role=operating_target_book; target_book_max=2026-06-12; broker_end=2026-06-12; date_gap_days=0; allowed_lag_days=7; rows=1282; path=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv
- `PASS` main_operating_target_book_available: operating_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv; rows=1282; max_date=2026-06-12
- `WARN` main_historical_research_book_reaches_broker_end: historical_book_max=2026-03-31; broker_end=2026-06-12; rows=2205; operating_book_max=2026-06-12; operating_rows=1282
...
- `WARN` concentrated_historical_research_book_reaches_broker_end: historical_book_max=2026-03-31; broker_end=2026-06-12; rows=23232; operating_book_max=2026-06-12; operating_rows=497
...
- `PASS` concentrated_concentration_contract: latest_date=2026-06-12; max_name=SNDK@28.50%; max_industry_group=Tech Hardware & Storage@45.07%; group_source=industry_group; violations=[]; preexisting_in_baseline=[]

## Data Quality Update Plan

- Readiness: ready_for_fullrun=`true`, ready_for_policy_replay=`true`, blockers=[], policy_blockers=[]
- Coverage: sec_enriched_candidate_present=`true`, smart_money_rows=34257, candidate_book=`/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/sec_enriched_candidate_replay/candidate_replay_book_sec_enriched.csv`
