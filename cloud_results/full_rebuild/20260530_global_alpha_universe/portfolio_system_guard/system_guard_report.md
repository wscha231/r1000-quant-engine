...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| main | 20.21% | 30.00% | 9.79pp | -33.27% | -15.00% | 18.27pp | false |
| concentrated | 33.20% | 50.00% | 16.80pp | -39.88% | -18.00% | 21.88pp | false |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| main | `main_latest_champion` | 29.88% | 0.12pp | -17.37% | 2.37pp | false | `blocked_both` |
| concentrated | `concentrated_latest_champion` | 48.42% | 1.58pp | -18.03% | 0.03pp | false | `blocked_both` |
...
- `PASS` main_target_book_reaches_broker_end: selected_role=operating_target_book; target_book_max=2026-05-29; broker_end=2026-05-29; rows=2223; path=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv
- `PASS` main_operating_target_book_available: operating_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv; rows=2223; max_date=2026-05-29
- `WARN` main_historical_research_book_reaches_broker_end: historical_book_max=2026-02-27; broker_end=2026-05-29; rows=2204; operating_book_max=2026-05-29; operating_rows=2223
...
- `PASS` concentrated_target_book_reaches_broker_end: selected_role=operating_target_book; target_book_max=2026-05-29; broker_end=2026-05-29; rows=23460; path=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_concentrated_target_book.csv
- `PASS` concentrated_operating_target_book_available: operating_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_concentrated_target_book.csv; rows=23460; max_date=2026-05-29
- `WARN` concentrated_historical_research_book_reaches_broker_end: historical_book_max=2026-02-27; broker_end=2026-05-29; rows=23457; operating_book_max=2026-05-29; operating_rows=23460
...
- `PASS` main_current_position_count_near_latest_target_count: main_positions=18; latest_target_rows=19; excess=0
