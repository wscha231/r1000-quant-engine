...
- sidecar_only: `true`
- production_policy: `market_leader_shadow`
- sidecar_applied_to_production: `false`
- current_holdings_source: `production_operating_target_book`
- source_target_run_id: ``
- source_target_case_id: ``
- promotion_status: `rejected`
- shadow_available: `true`
- projected_holdings_path: `/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/operator_review/projected_holdings_after_market_leader_target.csv`
- projected_market_leader_holdings_path: `/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/operator_review/projected_holdings_after_market_leader_target.csv`
...
- combined_projected_cash_after_ready_orders: `1.42%`
...
- production_mutation_audit_status: `missing`

## Reasons

- cash_policy_flag=cash_above_target
- current-vs-target implied turnover 85.90% > 30%
