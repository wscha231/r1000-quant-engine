...
- Main `main_N18_cap12_sub40_theme60_risk`: CAGR 34.68%, MDD -32.56%, Sharpe 1.206, mode `broker_ledger_next_close`
- Concentrated `concentrated_N5_cap30_sub70_risk`: CAGR 29.48%, MDD -51.81%, Sharpe 0.896, mode `broker_ledger_next_close`
