...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| main | 34.65% | 30.00% | 0.00pp | -26.00% | -25.00% | 1.00pp | false |
| concentrated | 45.06% | 50.00% | 4.94pp | -26.05% | -28.00% | 0.00pp | false |
...
- `main`: severity=`ok`, avg_cash=26.68%, latest_cash=14.93%, reasons=none
- `concentrated`: severity=`warn`, avg_cash=41.22%, latest_cash=5.78%, reasons=cash_drag_with_cagr_gap
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| main | `main_rebalance_interval_fixed_interval_I1` | 33.25% | 0.00pp | -14.22% | 0.00pp | true | `target_pass_review` |
| concentrated | `concentrated_grid_N2_conviction_curve_I1` | 51.77% | 0.00pp | -21.58% | 0.00pp | true | `target_pass_review` |
...
- `PASS` sec_enriched_candidate_materialized_for_audit: sec_enriched_candidate_present=True; rows_with_smart_money_evidence=33904
- `PASS` alphaops_vnext_uses_sec_enriched_candidate_book: candidate_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/sec_enriched_candidate_replay/candidate_replay_book_sec_enriched.csv; rows_with_smart_money_evidence=33904
...
- `WARN` main_historical_research_book_reaches_broker_end: historical_book_max=2026-03-31; broker_end=2026-06-18; rows=2072; operating_book_max=2026-06-18; operating_rows=1268
...
- `WARN` concentrated_historical_research_book_reaches_broker_end: historical_book_max=2026-03-31; broker_end=2026-06-18; rows=23190; operating_book_max=2026-06-18; operating_rows=491
...
- `PASS` concentrated_concentration_contract: latest_date=2026-06-18; max_name=SNDK@28.50%; max_industry_group=Tech Hardware & Storage@45.07%; group_source=industry_group; violations=[]; preexisting_in_baseline=[]

## Data Quality Update Plan

- Readiness: ready_for_fullrun=`true`, ready_for_policy_replay=`true`, blockers=[], policy_blockers=[]
- Coverage: sec_enriched_candidate_present=`true`, smart_money_rows=33904, candidate_book=`/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/sec_enriched_candidate_replay/candidate_replay_book_sec_enriched.csv`
