...
+
+policy_version: "2026-05-alphaops-20260516-v1"
+generated_at: "2026-05-16T18:05:03Z"
...
+evidence_summary:
+  main_cagr: 0.2028785105431481
+  main_sharpe: 1.4848607897809738
+  main_max_dd: -0.15275979516510796
+  main_avg_turnover_monthly: 0.5246327180707515
+  main_avg_stock_names: 23.914634146341463
+  concentrated_cagr: 0.28111314811671373
+  concentrated_sharpe: 1.583793078975827
+  concentrated_max_dd: -0.11445174764460198
+  trade_count: 737
+  concentrated_trade_count: 358
+  combined_trade_count: 1095
+  combined_win_rate: 0.5598173515981735
+  combined_avg_alpha_vs_benchmark: 0.02328115104184503
+  feature_gate_candidate_count: 3
...
+    ic: -0.1755
+    n: 167
+    rationale: "IC -0.175 in bear (n=167) <= disable threshold -0.05"
+  -
+    kind: "signal_regime_disable"
...
+    ic: -0.1384
+    n: 167
+    rationale: "IC -0.138 in bear (n=167) <= disable threshold -0.05"
+  -
...
+    ic: 0.136
+    n: 181
+    rationale: "IC +0.136 in bull (n=181) >= amplify threshold +0.1"
+sleeve_policy:
+  main_v2_balanced:
+    deep_bear:
+      core: 0.4
...
+    mandate: "main"
+    current_avg_stock_names: 23.914634146341463
...
+      cash: 0.05
+    evidence:
+      future_latest_multi_year_winner: 3.2673124660026467
+      early_latest_multi_year_winner: 0.43027352505127053
+      core_latest_multi_year_winner: 0.9673337266911259
