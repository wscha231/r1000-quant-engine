...
```json
{
  "concentrated_cagr": 0.28111314811671373,
  "concentrated_max_dd": -0.33804466965479363,
  "concentrated_sharpe": 0.72196241424563,
  "latest_concentrated_capacity": 0.1,
  "main_cagr": 0.1286319220673693,
  "main_max_dd": -0.27072447057026816,
  "main_sharpe": 0.6351022076912176
}
```
...
```json
{
  "main_avg_stock_names": 23.914634146341463,
  "main_avg_turnover_monthly": 0.5246327180707515,
  "main_cagr": 0.1286319220673693,
  "main_max_dd": -0.27072447057026816
}
```
...
```json
{
  "explosion_entry_n_all": 1095,
  "explosion_exit_n_all": 1095
}
```
