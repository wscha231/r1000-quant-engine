...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| main | 32.69% | 35.00% | 2.31pp | -28.45% | -25.00% | 3.45pp | false |
| concentrated | 38.66% | 50.00% | 11.34pp | -27.26% | -25.00% | 2.26pp | false |
...
- `main`: severity=`warn`, avg_cash=23.35%, latest_cash=6.46%, reasons=cash_drag_with_cagr_gap
- `concentrated`: severity=`warn`, avg_cash=44.36%, latest_cash=11.73%, reasons=cash_drag_with_cagr_gap
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| main | `main_rebalance_interval_fixed_interval_I1` | 32.28% | 2.72pp | -19.16% | 0.00pp | false | `needs_alpha_boost` |
| concentrated | `concentrated_grid_N3_score_power_I1` | 44.08% | 5.92pp | -21.54% | 0.00pp | false | `needs_alpha_boost` |
...
- `PASS` data_readiness_ready_for_production_replay: status=warn; ready_for_fullrun=True; ready_for_policy_replay=True; blockers=[]; policy_replay_blockers=[]; warnings=['price cache manifest end date is missing', 'dated target snapshot archive is missing for this run']
...
- `PASS` main_target_book_reaches_broker_end: selected_role=operating_target_book; target_book_max=2026-06-05; broker_end=2026-06-05; date_gap_days=0; allowed_lag_days=7; rows=1345; path=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv
- `PASS` main_operating_target_book_available: operating_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv; rows=1345; max_date=2026-06-05
- `WARN` main_historical_research_book_reaches_broker_end: historical_book_max=2026-03-31; broker_end=2026-06-05; rows=1761; operating_book_max=2026-06-05; operating_rows=1345
...
- `PASS` concentrated_target_book_reaches_broker_end: selected_role=operating_target_book; target_book_max=2026-06-05; broker_end=2026-06-05; date_gap_days=0; allowed_lag_days=7; rows=501; path=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_concentrated_target_book.csv
- `PASS` concentrated_operating_target_book_available: operating_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_concentrated_target_book.csv; rows=501; max_date=2026-06-05
- `WARN` concentrated_historical_research_book_reaches_broker_end: historical_book_max=2026-03-31; broker_end=2026-06-05; rows=23205; operating_book_max=2026-06-05; operating_rows=501
...
- `PASS` main_current_position_count_near_latest_target_count: main_positions=15; latest_target_rows=14; excess=1
...
- `PASS` feature_source_coverage_pit_available_from_clean: pit_future_available_from_rows=0; available_from_column_count=6
...
- Coverage: sec_enriched_candidate_present=`true`, smart_money_rows=34265, candidate_book=`/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/sec_enriched_candidate_replay/candidate_replay_book_sec_enriched.csv`
