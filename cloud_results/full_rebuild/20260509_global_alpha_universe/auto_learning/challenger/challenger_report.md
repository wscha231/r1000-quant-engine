...
| main | main_cagr_floor | hard | False | `0.20165834588806963` | `0.2685562961963095` |
| main | main_sharpe_floor | hard | False | `1.0971959712745438` | `1.5698608070881968` |
| main | main_max_dd_floor | hard | False | `-0.27307967491398366` | `-0.17837112497240137` |
...
| concentrated | concentrated_cagr_floor | hard | True | `0.4590237764170235` | `0.3` |
| concentrated | concentrated_max_dd_floor | hard | True | `-0.1345731720552199` | `-0.25` |
