...
```json
{
  "concentrated_cagr": 0.4590237764170235,
  "concentrated_max_dd": -0.37378783031424756,
  "concentrated_sharpe": 1.1828756807357603,
  "latest_concentrated_capacity": 0.1,
  "main_cagr": 0.1971854381058713,
  "main_max_dd": -0.3446750826700783,
  "main_sharpe": 0.9617652645855442
}
```
...
```json
{
  "main_avg_stock_names": 24.012048192771083,
  "main_avg_turnover_monthly": 0.5246756384545513,
  "main_cagr": 0.1971854381058713,
  "main_max_dd": -0.3446750826700783
}
```
...
```json
{
  "strong_clusters": [
    {
      "avg_realized_return": 0.08185795370390483,
      "cluster_id": "7",
      "n": 107,
      "win_rate": 0.6728971962616822
    }
  ],
  "weak_clusters": []
}
...
```json
{
  "explosion_entry_n_all": 995,
  "explosion_exit_n_all": 995
}
```
