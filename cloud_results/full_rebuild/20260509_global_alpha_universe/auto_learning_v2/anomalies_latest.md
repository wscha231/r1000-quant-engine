...
```json
{
  "strong_clusters": [
    {
      "avg_realized_return": 0.09176120881697901,
      "cluster_id": "2",
      "n": 158,
      "win_rate": 0.6329113924050633
    }
  ],
  "weak_clusters": [
    {
      "avg_realized_return": 0.07420482032317327,
      "cluster_id": "7",
      "n": 88,
      "win_rate": 0.4659090909090909
    },
    {
      "avg_realized_return": 0.05608274884788881,
      "cluster_id": "5",
      "n": 53,
...
```json
{
  "explosion_entry_n_all": 927,
  "explosion_exit_n_all": 927
}
```
