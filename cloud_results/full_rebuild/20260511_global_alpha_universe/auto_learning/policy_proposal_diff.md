...
+
+policy_version: "2026-05-alphaops-20260511-v1"
+generated_at: "2026-05-11T07:47:07Z"
...
+evidence_summary:
+  main_cagr: 0.273199775790429
+  main_sharpe: 1.6397079003602735
+  main_max_dd: -0.178652713102062
+  main_avg_turnover_monthly: 0.5228164477298215
+  main_avg_stock_names: 23.867924528301888
+  concentrated_cagr: 0.39863649261493617
+  concentrated_sharpe: 1.7049580372452717
+  concentrated_max_dd: -0.16584753860984158
+  trade_count: 911
+  concentrated_trade_count: 305
+  combined_trade_count: 1216
+  combined_win_rate: 0.5921052631578947
+  combined_avg_alpha_vs_benchmark: 0.04171227819051586
...
+    ic: -0.1687
+    n: 163
+    rationale: "IC -0.169 in bear (n=163) <= disable threshold -0.05"
+  -
...
+    ic: 0.126
+    n: 211
+    rationale: "IC +0.126 in bull (n=211) >= amplify threshold +0.1"
+  -
+    kind: "signal_regime_disable"
...
+    ic: -0.1034
+    n: 163
+    rationale: "IC -0.103 in bear (n=163) <= disable threshold -0.05"
+sleeve_policy:
+  main_v2_balanced:
+    deep_bear:
+      core: 0.4
...
+    mandate: "main"
+    current_avg_stock_names: 23.867924528301888
...
+      cash: 0.05
+    evidence:
+      future_latest_multi_year_winner: 3.332510722712174
+      early_latest_multi_year_winner: 0.2331900528142429
+      core_latest_multi_year_winner: 1.5713615003739145
