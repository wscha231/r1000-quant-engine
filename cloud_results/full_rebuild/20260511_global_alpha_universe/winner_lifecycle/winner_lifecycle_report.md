...
- generated_at_utc: `2026-05-11T07:52:24Z`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| STX | Information Technology | 5.5219 | 0.8262 | 1.8504 | 0.0 | strong_3m_momentum,strong_6m_momentum,strong_12m_momentum,high_relative_strength,entry_quality_chase_penalty,engine_likes_nonheld_name | fundamental_acceleration_override_replay |
...
| LITE | Information Technology | 5.0734 | 0.6373 | 2.8831 | 0.0 | strong_3m_momentum,strong_6m_momentum,strong_12m_momentum,high_relative_strength,entry_quality_chase_penalty,engine_likes_nonheld_name | fundamental_acceleration_override_replay |
...
| MRVL | Information Technology | 4.3544 | 1.1203 | 0.8336 | 0.0 | strong_3m_momentum,strong_6m_momentum,strong_12m_momentum,high_relative_strength,entry_quality_chase_penalty,engine_likes_nonheld_name | fundamental_acceleration_override_replay |
| RKLB | Industrials | 4.1435 | 0.4584 | 0.8694 | 0.0 | strong_3m_momentum,strong_6m_momentum,strong_12m_momentum,high_relative_strength,engine_likes_nonheld_name,ranking_mismatch | concentrated_or_alpha_sprint_replay |
| MTSI | Information Technology | 4.0942 | 0.5258 | 1.4043 | 0.0 | strong_3m_momentum,strong_6m_momentum,strong_12m_momentum,high_relative_strength,entry_quality_chase_penalty,engine_likes_nonheld_name,ranking_mismatch | fundamental_acceleration_override_replay |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| TXN | LITE | Information Technology | 3.1708 | 0.0613 | 0.3311 | 2.1032 | leadership_rotation_shadow_replay |
| LRCX | LITE | Information Technology | 2.7432 | 0.0613 | 0.3629 | 2.0965 | leadership_rotation_shadow_replay |
| AKAM | LITE | Information Technology | 2.4748 | 0.04 | 0.0838 | 1.8592 | leadership_rotation_shadow_replay |
| MLI | MTZ | Industrials | 2.437 | 0.04 | 0.3999 | 0.7692 | leadership_rotation_shadow_replay |
| TKR | MTZ | Industrials | 2.2721 | 0.04 | 0.4825 | 0.5659 | leadership_rotation_shadow_replay |
| ON | LITE | Information Technology | 2.1205 | 0.04 | 0.0545 | 1.8224 | leadership_rotation_shadow_replay |
| GLW | LITE | Information Technology | 1.7342 | 0.0603 | 0.1042 | 1.7255 | leadership_rotation_shadow_replay |
| PWR | BE | Industrials | 1.2134 | 0.0563 | 0.3585 | 0.2022 | leadership_rotation_shadow_replay |
