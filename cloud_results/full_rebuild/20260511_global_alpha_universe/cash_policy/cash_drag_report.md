...
- months: 83
- avg reported cash: 4.63%
- avg period-end cash: 20.63%
- avg explicit CASH in monthly book: 4.63%
- avg reported-vs-book cash gap: 0.00%
- avg target defense cash: 4.45%
- avg excess cash over target: 0.18%
- months reported cash >20%: 12
...
|---|---:|---:|
| `cap_limited_leftover` | 3 | 11.67% |
| `confirmed_macro_defense_cash` | 12 | 369.43% |
| `no_cash` | 66 | 0.28% |
| `partial_rebalance_leftover` | 2 | 2.82% |
...
| 2026-02-27 | 28.38% | 28.38% | 0.00% | 28.00% | risk_off_alert | partial_rebalance:core_compounder,early_scout | `confirmed_macro_defense_cash` | false | 28 / 18.0 |
...
| 2025-03-31 | 28.00% | 28.00% | 0.00% | 28.00% | risk_off_alert | rebalance | `confirmed_macro_defense_cash` | false | 18 / 18.0 |
| 2025-02-28 | 25.05% | 25.05% | 0.00% | 28.00% | risk_off_alert | partial_rebalance:core_compounder,early_scout | `confirmed_macro_defense_cash` | false | 43 / 18.0 |
