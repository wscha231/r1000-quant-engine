...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| main | 39.56% | 30.00% | 0.00pp | -24.46% | -25.00% | 0.00pp | true |
| concentrated | 50.62% | 50.00% | 0.00pp | -23.83% | -28.00% | 0.00pp | true |
...
- `main`: severity=`ok`, avg_cash=26.51%, latest_cash=15.54%, reasons=none
- `concentrated`: severity=`ok`, avg_cash=42.25%, latest_cash=6.33%, reasons=none
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| main | `main_broker_ledger_replay` | 39.56% | 0.00pp | -24.46% | 0.00pp | true | `target_pass_review` |
| concentrated | `concentrated_latest_champion` | 56.83% | 0.00pp | -23.01% | 0.00pp | true | `target_pass_review` |
...
- `PASS` sec_enriched_candidate_materialized_for_audit: sec_enriched_candidate_present=True; rows_with_smart_money_evidence=30220
- `PASS` alphaops_vnext_uses_sec_enriched_candidate_book: candidate_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/sec_enriched_candidate_replay/candidate_replay_book_sec_enriched.csv; rows_with_smart_money_evidence=30220
...
- `PASS` main_target_book_reaches_broker_end: selected_role=operating_target_book; target_book_max=2026-06-17; broker_end=2026-06-17; date_gap_days=0; allowed_lag_days=7; rows=1119; path=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv
- `PASS` main_operating_target_book_available: operating_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv; rows=1119; max_date=2026-06-17
- `WARN` main_historical_research_book_reaches_broker_end: historical_book_max=2026-03-31; broker_end=2026-06-17; rows=1976; operating_book_max=2026-06-17; operating_rows=1119
...
- `PASS` concentrated_target_book_reaches_broker_end: selected_role=operating_target_book; target_book_max=2026-06-17; broker_end=2026-06-17; date_gap_days=0; allowed_lag_days=7; rows=431; path=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_concentrated_target_book.csv
- `PASS` concentrated_operating_target_book_available: operating_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_concentrated_target_book.csv; rows=431; max_date=2026-06-17
- `WARN` concentrated_historical_research_book_reaches_broker_end: historical_book_max=2026-03-31; broker_end=2026-06-17; rows=20328; operating_book_max=2026-06-17; operating_rows=431
...
- `WARN` main_current_position_count_near_latest_target_count: main_positions=13; latest_target_rows=0; excess=13
...
- `PASS` main_cash_position_count_contract: latest_date=2026-06-17; cash=19.23%; stock_count=13; crisis_state=GREEN; violations=[]; preexisting_in_baseline=[]
- `PASS` concentrated_concentration_contract: latest_date=2026-06-17; max_name=SNDK@28.50%; max_industry_group=Tech Hardware & Storage@45.07%; group_source=industry_group; violations=[]; preexisting_in_baseline=[]

## Data Quality Update Plan

- Readiness: ready_for_fullrun=`true`, ready_for_policy_replay=`true`, blockers=[], policy_blockers=[]
- Coverage: sec_enriched_candidate_present=`true`, smart_money_rows=30220, candidate_book=`/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/sec_enriched_candidate_replay/candidate_replay_book_sec_enriched.csv`
