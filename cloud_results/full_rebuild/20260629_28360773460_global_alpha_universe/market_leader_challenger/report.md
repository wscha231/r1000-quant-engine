...
- Main `main_N18_cap12_sub40_theme60_risk`: CAGR 34.10%, MDD -32.22%, Sharpe 1.186, mode `broker_ledger_next_close`
- Concentrated `concentrated_N5_cap30_sub70_risk`: CAGR 28.55%, MDD -51.63%, Sharpe 0.871, mode `broker_ledger_next_close`
