...
| target_book_broker_cash_contract | fail | true | target-book or broker cash contract is incomplete |
...
- Run validate_target_book_cash_contract.py and fix explicit CASH rows or cash-ledger drift before treating results as official.
