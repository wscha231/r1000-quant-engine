...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| main | 35.28% | 30.00% | 0.00pp | -24.25% | -25.00% | 0.00pp | true |
| concentrated | 46.66% | 50.00% | 3.34pp | -24.12% | -28.00% | 0.00pp | false |
...
- `main`: severity=`ok`, avg_cash=26.54%, latest_cash=15.78%, reasons=none
- `concentrated`: severity=`warn`, avg_cash=40.48%, latest_cash=6.38%, reasons=cash_drag_with_cagr_gap
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| main | `main_rebalance_interval_fixed_interval_I1` | 32.99% | 0.00pp | -15.75% | 0.00pp | true | `target_pass_review` |
| concentrated | `concentrated_grid_N3_score_power_I1` | 49.97% | 0.03pp | -25.41% | 0.00pp | false | `needs_alpha_boost` |
...
- `PASS` main_target_book_reaches_broker_end: selected_role=operating_target_book; target_book_max=2026-06-26; broker_end=2026-06-26; date_gap_days=0; allowed_lag_days=7; rows=1282; path=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv
- `PASS` main_operating_target_book_available: operating_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv; rows=1282; max_date=2026-06-26
- `WARN` main_historical_research_book_reaches_broker_end: historical_book_max=2026-03-31; broker_end=2026-06-26; rows=2123; operating_book_max=2026-06-26; operating_rows=1282
...
- `PASS` concentrated_target_book_reaches_broker_end: selected_role=operating_target_book; target_book_max=2026-06-26; broker_end=2026-06-26; date_gap_days=0; allowed_lag_days=7; rows=537; path=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_concentrated_target_book.csv
- `PASS` concentrated_operating_target_book_available: operating_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_concentrated_target_book.csv; rows=537; max_date=2026-06-26
- `WARN` concentrated_historical_research_book_reaches_broker_end: historical_book_max=2026-03-31; broker_end=2026-06-26; rows=23205; operating_book_max=2026-06-26; operating_rows=537
...
- `PASS` main_cash_position_count_contract: latest_date=2026-06-26; cash=18.80%; stock_count=13; crisis_state=GREEN; violations=[]; preexisting_in_baseline=[]
- `PASS` concentrated_concentration_contract: latest_date=2026-06-26; max_name=SNDK@28.50%; max_industry_group=Tech Hardware & Storage@45.09%; group_source=industry_group; violations=[]; preexisting_in_baseline=[]
