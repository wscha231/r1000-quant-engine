...
```json
{
  "concentrated_cagr": 0.4770597336284852,
  "concentrated_max_dd": -0.19716786794336416,
  "concentrated_sharpe": 1.749531723854578,
  "latest_concentrated_capacity": 0.1,
  "main_cagr": 0.28116073881810344,
  "main_max_dd": -0.15921178440601547,
  "main_sharpe": 1.6202096991237043
}
```
...
```json
{
  "main_avg_stock_names": 24.97590361445783,
  "main_avg_turnover_monthly": 0.5292144217508118,
  "main_cagr": 0.28116073881810344,
  "main_max_dd": -0.15921178440601547
}
```
...
```json
{
  "strong_clusters": [
    {
      "avg_realized_return": 0.09031382915291407,
      "cluster_id": "2",
      "n": 142,
      "win_rate": 0.6267605633802817
    }
  ],
  "weak_clusters": [
    {
      "avg_realized_return": 0.06727704198772684,
      "cluster_id": "5",
      "n": 74,
...
```json
{
  "explosion_entry_n_all": 890,
  "explosion_exit_n_all": 890
}
```
