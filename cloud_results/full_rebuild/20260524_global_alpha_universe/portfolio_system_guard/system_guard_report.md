...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| main | 21.45% | 30.00% | 8.55pp | -32.45% | -15.00% | 17.45pp | false |
| concentrated | 36.61% | 50.00% | 13.39pp | -42.58% | -18.00% | 24.58pp | false |
...
- `PASS` daily_risk_overlay_backtest_validated: daily_risk_overlay_validated=True; nonmonthly_risk_action_count=569
- `WARN` full_nonmonthly_entry_replacement_backtest_validated: full_nonmonthly_entry_replacement_validated=False; daily_risk_action_evidence_count=569
- `PASS` orchestrator_replay_valid_for_promotion: status=completed; data_mode=historical_concentrated_monthly
- `PASS` main_target_book_reaches_broker_end: selected_role=operating_target_book; target_book_max=2026-05-22; broker_end=2026-05-22; rows=1678; path=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv
- `PASS` main_operating_target_book_available: operating_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv; rows=1678; max_date=2026-05-22
- `WARN` main_historical_research_book_reaches_broker_end: historical_book_max=2026-02-27; broker_end=2026-05-22; rows=1664; operating_book_max=2026-05-22; operating_rows=1678
...
- `PASS` concentrated_target_book_reaches_broker_end: selected_role=operating_target_book; target_book_max=2026-05-22; broker_end=2026-05-22; rows=22773; path=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_concentrated_target_book.csv
- `PASS` concentrated_operating_target_book_available: operating_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_concentrated_target_book.csv; rows=22773; max_date=2026-05-22
- `WARN` concentrated_historical_research_book_reaches_broker_end: historical_book_max=2026-02-27; broker_end=2026-05-22; rows=22770; operating_book_max=2026-05-22; operating_rows=22773
...
- `PASS` current_only_operating_holdings_available: /home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/operating_snapshot/current_operating_holdings_latest.csv; rows=18; legacy_snapshot_exists=True
- `PASS` main_current_position_count_near_latest_target_count: main_positions=14; latest_target_rows=14; excess=0
- `WARN` concentrated_replay_filter_matches_latest_target: broker_filter_n=2; latest_target_n=3; broker_mode=winner_take_all; latest_mode=score_power
