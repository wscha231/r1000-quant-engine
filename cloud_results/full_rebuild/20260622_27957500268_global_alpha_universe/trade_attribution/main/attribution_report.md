...
- Generated: 2026-06-22T16:34:56.282131+00:00
...
- Avg winner: $1,140
- Avg loser: $-639
- Total winners P&L: $728,445
- Total losers P&L: $-309,749

## MDD Window

- Peak: 2020-02-19, $125,220
- Trough: 2020-03-18, $92,597
- Drawdown: -26.05%
- Trades exited inside window: 14 (total P&L $-2,382)
...
| TSLA | $-4,453 | 2020-01-31 to 2020-02-28 | 2 | 5.7% | MARKET_LEADER | bear |

## Findings (machine-readable in findings.json)

### [HIGH] `F1_mdd_dominated_by_unrealized_holdings_main`

**Evidence**: MDD window 2020-02-19 to 2020-03-18 (-26.05% drawdown, equity loss $32,623) had only 14 round-trip exits totaling $-2,382 P&L. The drawdown is therefore dominated by unrealized loss on still-held positions (realized share 7.3%).
...
**Evidence**: 55% of total realized losses ($-171,744 of $-309,749) occurred in neutral regime, across 258 trades (avg $-666). The engine over-allocates or over-trades in this regime.
...
**Evidence**: target_exit losers average $-710 loss over 365 trades, while target_rebalance losers average $-422 over 120 trades. Explicit exits are firing too late.
