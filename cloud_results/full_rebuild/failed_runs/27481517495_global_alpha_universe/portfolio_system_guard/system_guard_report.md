...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| main | 22.14% | 35.00% | 12.86pp | -33.24% | -25.00% | 8.24pp | false |
| concentrated | 32.90% | 50.00% | 17.10pp | -37.96% | -25.00% | 12.96pp | false |
...
- `main`: severity=`ok`, avg_cash=5.96%, latest_cash=27.18%, reasons=none
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| main | `main_rebalance_interval_fixed_interval_I1` | 33.41% | 1.59pp | -15.61% | 0.00pp | false | `needs_alpha_boost` |
| concentrated | `concentrated_latest_champion` | 43.95% | 6.05pp | -20.29% | 0.00pp | false | `needs_alpha_boost` |
...
- `PASS` main_target_book_reaches_broker_end: selected_role=operating_target_book; target_book_max=2026-06-12; broker_end=2026-06-12; date_gap_days=0; allowed_lag_days=7; rows=1460; path=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv
- `PASS` main_operating_target_book_available: operating_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv; rows=1460; max_date=2026-06-12
- `WARN` main_historical_research_book_reaches_broker_end: historical_book_max=2026-03-31; broker_end=2026-06-12; rows=1445; operating_book_max=2026-06-12; operating_rows=1460
...
- `PASS` concentrated_target_book_reaches_broker_end: selected_role=operating_target_book; target_book_max=2026-06-12; broker_end=2026-06-12; date_gap_days=0; allowed_lag_days=7; rows=23212; path=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_concentrated_target_book.csv
- `PASS` concentrated_operating_target_book_available: operating_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_concentrated_target_book.csv; rows=23212; max_date=2026-06-12
- `WARN` concentrated_historical_research_book_reaches_broker_end: historical_book_max=2026-03-31; broker_end=2026-06-12; rows=23208; operating_book_max=2026-06-12; operating_rows=23212
...
- `PASS` main_current_position_count_near_latest_target_count: main_positions=14; latest_target_rows=15; excess=0
...
- `PASS` main_cash_position_count_contract: latest_date=2026-06-12; cash=8.00%; stock_count=14; crisis_state=unknown; violations=[]; preexisting_in_baseline=[]
- `ERROR` concentrated_concentration_contract: latest_date=2026-06-12; max_name=AMD@32.02%; max_industry_group=Semiconductors@84.08%; group_source=industry_group; violations=['concentrated_industry_group_weight_gt_60pct']; preexisting_in_baseline=[]
