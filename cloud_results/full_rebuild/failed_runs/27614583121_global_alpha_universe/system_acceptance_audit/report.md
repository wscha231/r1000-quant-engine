...
| data_readiness_price_macro_sec_etf | fail | true | data readiness has hard blockers |
...
| operational_order_preview_safety_bridge | fail | true | operating target book order bridge is missing or unsafe |
...
| portfolio_system_guard | fail | true | portfolio system guard found hard errors |
...
- Resolve data readiness blockers before treating any backtest as official.
...
- Run account order previews, live trading safety audit, and risk controls before treating results as operationally ready.
- Resolve portfolio system guard hard errors.
...
| main_oos_lottery_era_name_review | oos_lock | main | oos_is_cagr_ratio_above_lock | manual_review_no_workflow_dispatch | Compare IS/OOS top-name contribution and era buckets; require a new 8-year rebuild plus A/B verifier before promotion. |
