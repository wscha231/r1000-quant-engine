...
- scored latest rows: 259
- latest scored date: 2026-06-16
- historical candidate rows: 46776
...
- SEC-enriched candidate rows: 46776
...
- `AMAT`: historical_only_not_current_latest_universe; latest=False; hist_months=84; sleeve=``; score=None
- `AMD`: historical_only_not_current_latest_universe; latest=False; hist_months=72; sleeve=``; score=None
- `ANET`: selected_candidate_not_portfolio_ranked_high_enough; latest=True; hist_months=54; sleeve=`core_compounder`; score=4.005943033870861
- `ARM`: not_in_latest_universe; latest=False; hist_months=0; sleeve=``; score=None
- `ASML`: selected_candidate_not_portfolio_ranked_high_enough; latest=True; hist_months=0; sleeve=`core_compounder`; score=6.947505693438864
- `AVGO`: historical_only_not_current_latest_universe; latest=False; hist_months=84; sleeve=``; score=None
- `CIEN`: historical_only_not_current_latest_universe; latest=False; hist_months=84; sleeve=``; score=None
- `COHR`: historical_only_not_current_latest_universe; latest=False; hist_months=22; sleeve=``; score=None
- `DELL`: selected_candidate_not_portfolio_ranked_high_enough; latest=True; hist_months=7; sleeve=`core_compounder`; score=4.727074611348466
- `GEV`: historical_only_not_current_latest_universe; latest=False; hist_months=10; sleeve=``; score=None
- `GLW`: historical_only_not_current_latest_universe; latest=False; hist_months=10; sleeve=``; score=None
- `GOOGL`: historical_only_not_current_latest_universe; latest=False; hist_months=84; sleeve=``; score=None
- `HPE`: selection_gate_or_rank_rejected; latest=True; hist_months=84; sleeve=`unassigned`; score=7.462628915897476
- `INTC`: historical_only_not_current_latest_universe; latest=False; hist_months=63; sleeve=``; score=None
- `KLAC`: selected_candidate_not_portfolio_ranked_high_enough; latest=True; hist_months=81; sleeve=`early_scout`; score=7.552050343396091
- `LITE`: selection_gate_or_rank_rejected; latest=True; hist_months=72; sleeve=`unassigned`; score=4.980918589434931
- `LRCX`: historical_only_not_current_latest_universe; latest=False; hist_months=84; sleeve=``; score=None
- `MRVL`: historical_only_not_current_latest_universe; latest=False; hist_months=50; sleeve=``; score=None
- `MU`: historical_only_not_current_latest_universe; latest=False; hist_months=84; sleeve=``; score=None
- `NVDA`: historical_only_not_current_latest_universe; latest=False; hist_months=66; sleeve=``; score=None
- `OKLO`: historical_only_not_current_latest_universe; latest=False; hist_months=6; sleeve=``; score=None
- `PLTR`: selected_candidate_not_portfolio_ranked_high_enough; latest=True; hist_months=28; sleeve=`core_compounder`; score=2.541145415292508
- `QCOM`: historical_only_not_current_latest_universe; latest=False; hist_months=84; sleeve=``; score=None
...
- `SNDK`: historical_only_not_current_latest_universe; latest=False; hist_months=3; sleeve=``; score=None
- `STX`: not_in_latest_universe; latest=False; hist_months=0; sleeve=``; score=None
- `TSM`: selected_candidate_not_portfolio_ranked_high_enough; latest=True; hist_months=0; sleeve=`core_compounder`; score=4.345021482145473
- `VRT`: selected_candidate_not_portfolio_ranked_high_enough; latest=True; hist_months=49; sleeve=`core_compounder`; score=4.540225346583519
- `WDC`: historical_only_not_current_latest_universe; latest=False; hist_months=39; sleeve=``; score=None
- `WMT`: historical_only_not_current_latest_universe; latest=False; hist_months=24; sleeve=``; score=None
