...
- sidecar_only: `true`
- production_policy: `production_baseline`
...
- combined_projected_cash_after_ready_orders: `0.09%`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| main | 21.87% | -26.37% | 1.042 | missing | missing | 0 |
| concentrated | 28.54% | -42.96% | 1.002 | missing | missing | 0 |
