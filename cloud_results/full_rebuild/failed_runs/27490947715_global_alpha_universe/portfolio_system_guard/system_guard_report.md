...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| main | 21.87% | 35.00% | 13.13pp | -26.37% | -25.00% | 1.37pp | false |
| concentrated | 28.54% | 50.00% | 21.46pp | -42.96% | -25.00% | 17.96pp | false |
...
- `main`: severity=`ok`, avg_cash=5.93%, latest_cash=26.86%, reasons=none
- `concentrated`: severity=`ok`, avg_cash=0.05%, latest_cash=0.01%, reasons=none
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| main | `main_latest_champion` | 31.13% | 3.87pp | -13.07% | 0.00pp | false | `needs_alpha_boost` |
| concentrated | `concentrated_latest_champion` | 41.50% | 8.50pp | -22.74% | 0.00pp | false | `needs_alpha_boost` |
...
- `PASS` main_target_book_reaches_broker_end: selected_role=operating_target_book; target_book_max=2026-06-12; broker_end=2026-06-12; date_gap_days=0; allowed_lag_days=7; rows=1797; path=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv
- `PASS` main_operating_target_book_available: operating_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv; rows=1797; max_date=2026-06-12
- `WARN` main_historical_research_book_reaches_broker_end: historical_book_max=2026-03-31; broker_end=2026-06-12; rows=1779; operating_book_max=2026-06-12; operating_rows=1797
...
- `PASS` concentrated_target_book_reaches_broker_end: selected_role=operating_target_book; target_book_max=2026-06-12; broker_end=2026-06-12; date_gap_days=0; allowed_lag_days=7; rows=23200; path=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_concentrated_target_book.csv
- `PASS` concentrated_operating_target_book_available: operating_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_concentrated_target_book.csv; rows=23200; max_date=2026-06-12
- `WARN` concentrated_historical_research_book_reaches_broker_end: historical_book_max=2026-03-31; broker_end=2026-06-12; rows=23196; operating_book_max=2026-06-12; operating_rows=23200
...
- `PASS` current_only_operating_holdings_available: /home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/operating_snapshot/current_operating_holdings_latest.csv; rows=24; legacy_snapshot_exists=True
- `PASS` main_current_position_count_near_latest_target_count: main_positions=18; latest_target_rows=18; excess=0
...
- `ERROR` concentrated_concentration_contract: latest_date=2026-06-12; max_name=AMD@31.83%; max_industry_group=Semiconductors@83.17%; group_source=industry_group; violations=['concentrated_industry_group_weight_gt_60pct']; preexisting_in_baseline=[]
