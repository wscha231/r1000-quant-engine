...
- combined_projected_cash_after_ready_orders: `12.04%`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| main | 34.28% | -27.18% | 1.256 | missing | missing | 0 |
| concentrated | 44.37% | -24.70% | 1.399 | missing | missing | 0 |
...
- production_promotion_blocker=main.data_readiness_status=blocked
- production_promotion_blocker=main.data_readiness_policy_replay_ready=false
...
- production_promotion_blocker=main.broker_ledger_window_gate.data_readiness.status=blocked
- production_promotion_blocker=main.broker_ledger_window_gate.data_readiness.ready_for_policy_replay=false
...
- production_promotion_blocker=concentrated.data_readiness_status=blocked
- production_promotion_blocker=concentrated.data_readiness_policy_replay_ready=false
...
- production_promotion_blocker=concentrated.broker_ledger_window_gate.data_readiness.status=blocked
- production_promotion_blocker=concentrated.broker_ledger_window_gate.data_readiness.ready_for_policy_replay=false
