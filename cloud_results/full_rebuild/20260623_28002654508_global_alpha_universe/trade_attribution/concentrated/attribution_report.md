...
- Generated: 2026-06-23T08:17:02.594925+00:00
...
- Avg winner: $4,957
- Avg loser: $-1,346
- Total winners P&L: $1,055,840
- Total losers P&L: $-234,140

## MDD Window

- Peak: 2021-11-18, $224,507
- Trough: 2023-08-17, $169,279
- Drawdown: -24.60%
- Trades exited inside window: 90 (total P&L $-24,889)
...
| --- | ---: | ---: | ---: | ---: | --- |
| weak_confirmation_weighted | $-131,131 | 13 | 10.8% | 27.3% | NVDA, BLD, ORLY, MA, MLI, XPO, NET, WCC |
| information_technology_loss_cluster | $-88,624 | 7 | 11.9% | 28.5% | DDOG, NVDA, NET, ON, ONTO, MSI, JBL |
| high_weight_market_leader | $-73,773 | 10 | 15.5% | 28.5% | DDOG, XPO, NET, ON, DXCM, ONTO, PCTY, JBL |
| negative_short_rs_weighted | $-69,917 | 6 | 9.3% | 20.0% | NVDA, BLD, ORLY, TXRH, JBL, CHE |
...
| --- | ---: | --- | ---: | ---: | --- | --- |
| DDOG | $-42,141 | 2021-10-29 to 2021-11-30 | 2 | 19.3% | MARKET_LEADER | neutral |
| NVDA | $-30,030 | 2021-11-30 to 2021-12-31 | 2 | 7.6% | MARKET_LEADER | bull |
...
| MLI | $-11,670 | 2023-02-28 to 2023-03-31 | 2 | 10.7% | MARKET_LEADER | bull |
...
**Evidence**: Operating target-book rows linked to MDD losers show bucket `weak_confirmation_weighted` with $-131,131 linked position P&L (65% of top context loss), 13 tickers, avg weight 10.8%, max weight 27.3%. Top tickers: NVDA, BLD, ORLY, MA, MLI, XPO, NET, WCC, LOPE, DXCM, RKLB, ONTO.
