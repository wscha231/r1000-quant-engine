...
- Generated: 2026-06-23T08:17:02.299555+00:00
...
- Avg winner: $1,147
- Avg loser: $-645
- Total winners P&L: $732,953
- Total losers P&L: $-311,345

## MDD Window

- Peak: 2020-02-19, $125,228
- Trough: 2020-03-18, $92,628
- Drawdown: -26.03%
- Trades exited inside window: 14 (total P&L $-2,377)
...
| PENN | $-7,275 | 2020-01-31 to 2020-02-28 | 2 | 5.6% | MARKET_LEADER | bear |
| NOW | $-7,005 | 2020-01-31 to 2020-02-28 | 2 | 12.0% | MARKET_LEADER | bear |
| STM | $-6,038 | 2020-01-31 to 2020-02-28 | 2 | 5.6% | MARKET_LEADER | bear |
...
| SHOP | $-4,491 | 2020-01-31 to 2020-02-28 | 2 | 5.6% | MARKET_LEADER | bear |
...
**Evidence**: MDD window 2020-02-19 to 2020-03-18 (-26.03% drawdown, equity loss $32,600) had only 14 round-trip exits totaling $-2,377 P&L. The drawdown is therefore dominated by unrealized loss on still-held positions (realized share 7.3%).
...
**Evidence**: 56% of total realized losses ($-173,233 of $-311,345) occurred in neutral regime, across 257 trades (avg $-674). The engine over-allocates or over-trades in this regime.
...
**Evidence**: target_exit losers average $-717 loss over 363 trades, while target_rebalance losers average $-425 over 120 trades. Explicit exits are firing too late.
