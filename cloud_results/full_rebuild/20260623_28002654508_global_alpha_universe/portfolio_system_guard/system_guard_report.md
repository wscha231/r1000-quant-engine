...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| main | 35.02% | 30.00% | 0.00pp | -26.03% | -25.00% | 1.03pp | false |
| concentrated | 45.96% | 50.00% | 4.04pp | -24.60% | -28.00% | 0.00pp | false |
...
- `main`: severity=`ok`, avg_cash=26.36%, latest_cash=14.63%, reasons=none
- `concentrated`: severity=`warn`, avg_cash=41.33%, latest_cash=5.54%, reasons=cash_drag_with_cagr_gap
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| main | `main_latest_champion` | 35.30% | 0.00pp | -15.54% | 0.00pp | true | `target_pass_review` |
| concentrated | `concentrated_latest_champion` | 51.61% | 0.00pp | -18.40% | 0.00pp | true | `target_pass_review` |
...
- `PASS` data_readiness_ready_for_production_replay: status=warn; ready_for_fullrun=True; ready_for_policy_replay=True; blockers=[]; policy_replay_blockers=[]; warnings=['latest target date 2026-06-23 is after latest observable close 2026-06-22; freshness gate uses observable close', 'dated target snapshot archive is missing for this run']
- `PASS` dataset_coverage_audit_available: outputs/reports/dataset_coverage_audit.json
- `PASS` sec_enriched_candidate_materialized_for_audit: sec_enriched_candidate_present=True; rows_with_smart_money_evidence=33694
- `PASS` alphaops_vnext_uses_sec_enriched_candidate_book: candidate_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/sec_enriched_candidate_replay/candidate_replay_book_sec_enriched.csv; rows_with_smart_money_evidence=33694
...
- `PASS` main_target_book_reaches_broker_end: selected_role=operating_target_book; target_book_max=2026-06-22; broker_end=2026-06-22; date_gap_days=0; allowed_lag_days=7; rows=1267; path=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv
- `PASS` main_operating_target_book_available: operating_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv; rows=1267; max_date=2026-06-22
- `WARN` main_historical_research_book_reaches_broker_end: historical_book_max=2026-03-31; broker_end=2026-06-22; rows=1472; operating_book_max=2026-06-22; operating_rows=1267
...
- `PASS` concentrated_target_book_reaches_broker_end: selected_role=operating_target_book; target_book_max=2026-06-22; broker_end=2026-06-22; date_gap_days=0; allowed_lag_days=7; rows=490; path=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_concentrated_target_book.csv
- `PASS` concentrated_operating_target_book_available: operating_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_concentrated_target_book.csv; rows=490; max_date=2026-06-22
- `WARN` concentrated_historical_research_book_reaches_broker_end: historical_book_max=2026-03-31; broker_end=2026-06-22; rows=23160; operating_book_max=2026-06-22; operating_rows=490
...
- `PASS` main_current_position_count_near_latest_target_count: main_positions=13; latest_target_rows=13; excess=0
...
- `PASS` main_cash_position_count_contract: latest_date=2026-06-22; cash=19.19%; stock_count=13; crisis_state=GREEN; violations=[]; preexisting_in_baseline=[]
- `PASS` concentrated_concentration_contract: latest_date=2026-06-22; max_name=SNDK@28.50%; max_industry_group=Tech Hardware & Storage@45.12%; group_source=industry_group; violations=[]; preexisting_in_baseline=[]

## Data Quality Update Plan

- Readiness: ready_for_fullrun=`true`, ready_for_policy_replay=`true`, blockers=[], policy_blockers=[]
- Coverage: sec_enriched_candidate_present=`true`, smart_money_rows=33694, candidate_book=`/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/sec_enriched_candidate_replay/candidate_replay_book_sec_enriched.csv`
