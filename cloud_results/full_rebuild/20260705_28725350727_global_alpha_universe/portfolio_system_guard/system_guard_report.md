...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| main | 32.94% | 30.00% | 0.00pp | -25.65% | -25.00% | 0.65pp | false |
| concentrated | 46.99% | 50.00% | 3.01pp | -23.22% | -28.00% | 0.00pp | false |
...
- `main`: severity=`ok`, avg_cash=29.34%, latest_cash=11.03%, reasons=none
- `concentrated`: severity=`warn`, avg_cash=41.04%, latest_cash=16.88%, reasons=cash_drag_with_cagr_gap
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| main | `main_rebalance_interval_fixed_interval_I1` | 34.06% | 0.00pp | -15.38% | 0.00pp | true | `target_pass_review` |
| concentrated | `concentrated_grid_N2_winner_take_all_I1` | 54.65% | 0.00pp | -25.56% | 0.00pp | true | `target_pass_review` |
...
- `PASS` data_readiness_ready_for_production_replay: status=warn; ready_for_fullrun=True; ready_for_policy_replay=True; blockers=[]; policy_replay_blockers=[]; warnings=['dated target snapshot archive is missing for this run']
- `PASS` dataset_coverage_audit_available: outputs/reports/dataset_coverage_audit.json
- `PASS` sec_enriched_candidate_materialized_for_audit: sec_enriched_candidate_present=True; rows_with_smart_money_evidence=34732
- `PASS` alphaops_vnext_uses_sec_enriched_candidate_book: candidate_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/sec_enriched_candidate_replay/candidate_replay_book_sec_enriched.csv; rows_with_smart_money_evidence=34732
...
- `PASS` main_target_book_reaches_broker_end: selected_role=operating_target_book; target_book_max=2026-07-02; broker_end=2026-07-02; date_gap_days=0; allowed_lag_days=7; rows=1207; path=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv
- `PASS` main_operating_target_book_available: operating_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv; rows=1207; max_date=2026-07-02
- `WARN` main_historical_research_book_reaches_broker_end: historical_book_max=2026-04-30; broker_end=2026-07-02; rows=2296; operating_book_max=2026-07-02; operating_rows=1207
...
- `PASS` concentrated_target_book_reaches_broker_end: selected_role=operating_target_book; target_book_max=2026-07-02; broker_end=2026-07-02; date_gap_days=0; allowed_lag_days=7; rows=545; path=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_concentrated_target_book.csv
- `PASS` concentrated_operating_target_book_available: operating_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_concentrated_target_book.csv; rows=545; max_date=2026-07-02
- `WARN` concentrated_historical_research_book_reaches_broker_end: historical_book_max=2026-04-30; broker_end=2026-07-02; rows=23496; operating_book_max=2026-07-02; operating_rows=545
...
- `PASS` current_only_operating_holdings_available: /home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/operating_snapshot/current_operating_holdings_latest.csv; rows=21; legacy_snapshot_exists=True
- `PASS` main_current_position_count_near_latest_target_count: main_positions=14; latest_target_rows=19; excess=0
...
- `PASS` main_cash_position_count_contract: latest_date=2026-07-02; cash=10.82%; stock_count=14; crisis_state=GREEN; violations=[]; preexisting_in_baseline=[]
- `PASS` concentrated_concentration_contract: latest_date=2026-07-02; max_name=MU@30.00%; max_industry_group=Semiconductors@55.42%; group_source=industry_group; violations=[]; preexisting_in_baseline=[]

## Data Quality Update Plan

- Readiness: ready_for_fullrun=`true`, ready_for_policy_replay=`true`, blockers=[], policy_blockers=[]
- Coverage: sec_enriched_candidate_present=`true`, smart_money_rows=34732, candidate_book=`/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/sec_enriched_candidate_replay/candidate_replay_book_sec_enriched.csv`
