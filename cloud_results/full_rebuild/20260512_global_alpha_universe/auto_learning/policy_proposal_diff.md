...
+
+policy_version: "2026-05-alphaops-20260512-v1"
+generated_at: "2026-05-12T23:08:28Z"
...
+evidence_summary:
+  main_cagr: 0.2918710779126912
+  main_sharpe: 1.7248976396719429
+  main_max_dd: -0.17462786046803547
+  main_avg_turnover_monthly: 0.529198387898223
+  main_avg_stock_names: 26.216867469879517
+  concentrated_cagr: 0.4894016706042674
+  concentrated_sharpe: 1.7406704160388327
+  concentrated_max_dd: -0.16665464216428827
+  trade_count: 737
+  concentrated_trade_count: 150
+  combined_trade_count: 887
+  combined_win_rate: 0.5727170236753101
+  combined_avg_alpha_vs_benchmark: 0.04350296405205424
...
+    ic: -0.0786
+    n: 138
+    rationale: "IC -0.079 in bear (n=138) <= disable threshold -0.05"
+  -
+    kind: "signal_regime_disable"
...
+    ic: -0.068
+    n: 138
+    rationale: "IC -0.068 in bear (n=138) <= disable threshold -0.05"
+  -
...
+    ic: 0.1025
+    n: 369
+    rationale: "IC +0.102 in neutral (n=369) >= amplify threshold +0.1"
+sleeve_policy:
+  main_v2_balanced:
+    deep_bear:
+      core: 0.4
...
+    mandate: "main"
+    current_avg_stock_names: 26.216867469879517
...
+      cash: 0.05
+    evidence:
+      future_latest_multi_year_winner: 3.3209259627810015
+      early_latest_multi_year_winner: 0.35485338379346126
+      core_latest_multi_year_winner: 1.4995771633007708
