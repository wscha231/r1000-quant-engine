...
- Generated: 2026-06-21T22:59:44.311107+00:00
...
- Avg winner: $4,807
- Avg loser: $-1,327
- Total winners P&L: $1,028,685
- Total losers P&L: $-236,264

## MDD Window

- Peak: 2021-11-08, $231,334
- Trough: 2023-08-17, $171,514
- Drawdown: -25.86%
- Trades exited inside window: 93 (total P&L $-24,901)
...
| --- | ---: | ---: | ---: | ---: | --- |
| weak_confirmation_weighted | $-129,364 | 13 | 10.8% | 26.9% | NVDA, BLD, ORLY, MA, MLI, XPO, NET, WCC |
| qqq_underperforms_spy_weighted | $-117,716 | 12 | 12.5% | 28.5% | DDOG, BLD, ORLY, MA, XPO, LOPE, DXCM, JBL |
| information_technology_loss_cluster | $-94,205 | 8 | 11.7% | 28.5% | DDOG, NVDA, NET, BILL, ON, ONTO, JBL, MSI |
| high_weight_market_leader | $-79,653 | 10 | 15.8% | 28.5% | DDOG, XPO, NET, BILL, ON, DXCM, ONTO, TSLA |
| negative_short_rs_weighted | $-71,499 | 6 | 9.3% | 20.0% | NVDA, BLD, ORLY, JBL, TXRH, CHE |
| high_vol_weighted | $-3,707 | 2 | 9.5% | 11.4% | RKLB, TXRH |
...
| NVDA | $-30,107 | 2021-11-30 to 2021-12-31 | 2 | 7.6% | MARKET_LEADER | bull |
...
| MLI | $-12,023 | 2023-02-28 to 2023-03-31 | 2 | 10.7% | MARKET_LEADER | bull |
| XPO | $-11,180 | 2023-06-30 to 2023-07-31 | 2 | 20.0% | MARKET_LEADER | bull |
...
**Evidence**: target_exit losers average $-1,402 loss over 130 trades, while target_rebalance losers average $-1,124 over 48 trades. Explicit exits are firing too late.
...
**Evidence**: Operating target-book rows linked to MDD losers show bucket `weak_confirmation_weighted` with $-129,364 linked position P&L (61% of top context loss), 13 tickers, avg weight 10.8%, max weight 26.9%. Top tickers: NVDA, BLD, ORLY, MA, MLI, XPO, NET, WCC, LOPE, RKLB, DXCM, ONTO.
