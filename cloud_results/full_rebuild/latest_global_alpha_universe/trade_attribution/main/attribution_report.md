...
- Generated: 2026-06-21T22:59:44.010643+00:00
...
- Avg winner: $1,153
- Avg loser: $-660
- Total winners P&L: $740,271
- Total losers P&L: $-318,234

## MDD Window

- Peak: 2020-02-19, $127,659
- Trough: 2020-03-18, $94,406
- Drawdown: -26.05%
- Trades exited inside window: 14 (total P&L $-1,932)
...
| --- | ---: | ---: | ---: | ---: | --- |
| information_technology_loss_cluster | $-30,334 | 6 | 6.5% | 12.0% | AMD, NOW, FTNT, QRVO, RNG, UI |
...
| SHOP | $-4,553 | 2020-01-31 to 2020-02-28 | 2 | 5.6% | MARKET_LEADER | bear |
...
**Evidence**: MDD window 2020-02-19 to 2020-03-18 (-26.05% drawdown, equity loss $33,253) had only 14 round-trip exits totaling $-1,932 P&L. The drawdown is therefore dominated by unrealized loss on still-held positions (realized share 5.8%).
...
**Evidence**: 56% of total realized losses ($-179,042 of $-318,234) occurred in neutral regime, across 255 trades (avg $-702). The engine over-allocates or over-trades in this regime.
...
**Evidence**: target_exit losers average $-737 loss over 363 trades, while target_rebalance losers average $-425 over 119 trades. Explicit exits are firing too late.
...
**Evidence**: Operating target-book rows linked to MDD losers show bucket `information_technology_loss_cluster` with $-30,334 linked position P&L (41% of top context loss), 6 tickers, avg weight 6.5%, max weight 12.0%. Top tickers: AMD, NOW, FTNT, QRVO, RNG, UI.
