...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| main | 34.51% | 35.00% | 0.49pp | -26.01% | -25.00% | 1.01pp | false |
| concentrated | 44.86% | 50.00% | 5.14pp | -25.83% | -25.00% | 0.83pp | false |
...
- `main`: severity=`warn`, avg_cash=26.61%, latest_cash=16.07%, reasons=cash_drag_with_cagr_gap
- `concentrated`: severity=`warn`, avg_cash=42.31%, latest_cash=6.60%, reasons=cash_drag_with_cagr_gap
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| main | `main_broker_ledger_replay` | 34.51% | 0.49pp | -26.01% | 1.01pp | false | `blocked_both` |
| concentrated | `concentrated_grid_N2_conviction_curve_I2` | 49.33% | 0.67pp | -24.60% | 0.00pp | false | `needs_alpha_boost` |
...
- `PASS` main_target_book_reaches_broker_end: selected_role=operating_target_book; target_book_max=2026-06-12; broker_end=2026-06-12; date_gap_days=0; allowed_lag_days=7; rows=1283; path=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv
- `PASS` main_operating_target_book_available: operating_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv; rows=1283; max_date=2026-06-12
- `WARN` main_historical_research_book_reaches_broker_end: historical_book_max=2026-03-31; broker_end=2026-06-12; rows=2172; operating_book_max=2026-06-12; operating_rows=1283
...
- `WARN` concentrated_historical_research_book_reaches_broker_end: historical_book_max=2026-03-31; broker_end=2026-06-12; rows=23199; operating_book_max=2026-06-12; operating_rows=497
...
- `PASS` main_cash_position_count_contract: latest_date=2026-06-12; cash=19.23%; stock_count=13; crisis_state=GREEN; violations=[]; preexisting_in_baseline=[]
- `PASS` concentrated_concentration_contract: latest_date=2026-06-12; max_name=SNDK@28.50%; max_industry_group=Tech Hardware & Storage@45.01%; group_source=industry_group; violations=[]; preexisting_in_baseline=[]
