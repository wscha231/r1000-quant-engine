...
- months: 83
- avg reported cash: 4.99%
- avg period-end cash: 21.05%
- avg explicit CASH in monthly book: 4.99%
- avg reported-vs-book cash gap: 0.00%
- avg target defense cash: 4.80%
- avg excess cash over target: 0.19%
...
|---|---:|---:|
| `confirmed_macro_defense_cash` | 13 | 407.56% |
| `idle_cash_candidate` | 2 | 6.41% |
| `no_cash` | 68 | 0.00% |
...
| 2022-04-29 | 33.83% | 33.83% | 0.00% | 28.00% | risk_off_alert | rebalance | `confirmed_macro_defense_cash` | false | 23 / 18.0 |
| 2025-03-31 | 31.43% | 31.43% | 0.00% | 28.00% | risk_off_alert | rebalance | `confirmed_macro_defense_cash` | false | 27 / 18.0 |
| 2021-02-26 | 28.12% | 28.12% | 0.00% | 28.00% | risk_off_alert | rebalance | `confirmed_macro_defense_cash` | false | 27 / 18.0 |
| 2026-02-27 | 28.01% | 28.01% | 0.00% | 28.00% | risk_off_alert | partial_rebalance:core_compounder,early_scout | `confirmed_macro_defense_cash` | false | 27 / 18.0 |
