...
| `mixed_risk_and_idle_cash` | 2 | 86.14% |
| `no_cash` | 4 | 0.00% |
| `partial_rebalance_leftover` | 2 | 2.79% |
| `risk_defense_cash` | 6 | 218.34% |
...
| 2022-03-31 | 70.83% | 0.00% | 70.83% | 0.00% | growth_reentry_alert | partial_rebalance:core_compounder,early_scout | `cash_export_mismatch` | false | 18 / 18.0 |
...
| 2022-05-31 | 54.24% | 0.00% | 54.24% | 0.00% | balanced | circuit_breaker_rebalance | `cash_export_mismatch` | false | 30 / 18.0 |
| 2023-08-31 | 48.19% | 0.00% | 48.19% | 0.00% | balanced | partial_rebalance:core_compounder,early_scout | `cash_export_mismatch` | false | 18 / 18.0 |
| 2021-01-29 | 45.96% | 28.00% | 17.96% | 28.00% | risk_off_alert | partial_rebalance:core_compounder,early_scout | `mixed_risk_and_idle_cash` | false | 17 / 18.0 |
| 2023-09-29 | 44.10% | 40.00% | 4.10% | 40.00% | systemic_alert | rebalance | `risk_defense_cash` | false | 17 / 18.0 |
| 2024-07-31 | 40.78% | 40.00% | 0.78% | 40.00% | systemic_alert | rebalance | `risk_defense_cash` | false | 18 / 18.0 |
| 2021-02-26 | 40.18% | 28.00% | 12.18% | 28.00% | risk_off_alert | rebalance | `mixed_risk_and_idle_cash` | false | 17 / 18.0 |
...
| 2021-10-29 | 27.11% | 0.00% | 27.11% | 0.00% | growth_reentry_alert | rebalance | `cash_export_mismatch` | 25 / 18.0 |
| 2025-12-31 | 25.89% | 0.00% | 25.89% | 0.00% | balanced | partial_rebalance:core_compounder,early_scout | `cash_export_mismatch` | 34 / 18.0 |
| 2019-04-30 | 21.49% | 0.00% | 21.49% | 0.00% | balanced | initial_rebalance | `cash_export_mismatch` | 18 / 18.0 |
| 2021-03-31 | 20.13% | 0.00% | 20.13% | 0.00% | growth_reentry_alert | partial_rebalance:core_compounder,early_scout | `cash_export_mismatch` | 27 / 18.0 |
