...
| --- | --- | --- | --- | --- | :---: |
| conc_continuation_winner_relaxation | queued | concentrated:structural_underinvestment_bull | 27873592126 | PHASE_CONCENTRATED_CONTINUATION_RELAX_ENABLED=1 | yes |
| conc_bull_floor_stock_min | queued | concentrated:structural_underinvestment_bull | 27873592126 | PHASE_REGIME_CAPACITY_BULL_FLOOR_ENABLED=1 | yes |
| conc_reentry_quality | queued | concentrated:structural_underinvestment_bull | 27873592126 | PHASE_CONCENTRATED_REENTRY_QUALITY_ENABLED=1 | yes |
| conc_theme_leadership_boost | queued | concentrated:structural_underinvestment_bull | 27873592126 | PHASE_THEME_LEADERSHIP_BOOST_ENABLED=1 | yes |
| conc_concentration_cap_relaxation | queued | concentrated:structural_underinvestment_bull | 27873592126 | PHASE_CONCENTRATED_CAP_RELAX_ENABLED=1 | yes |
