...
| alpha_sprint_breakout_fallback_v1 | weekly_leader_entry_broker_replay | `counterfactual_available` | false | -23.58 | 9.21 | Weekly leader-entry broker replay is available as account-like counterfactual evidence; keep proposal-only until stress/cost gates pass. |
