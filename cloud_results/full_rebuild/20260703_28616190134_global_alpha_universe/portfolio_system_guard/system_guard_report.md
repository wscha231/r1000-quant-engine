...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| main | 30.61% | 30.00% | 0.00pp | -26.02% | -25.00% | 1.02pp | false |
| concentrated | 44.53% | 50.00% | 5.47pp | -23.27% | -28.00% | 0.00pp | false |
...
- `main`: severity=`ok`, avg_cash=26.39%, latest_cash=5.21%, reasons=none
- `concentrated`: severity=`warn`, avg_cash=41.54%, latest_cash=17.06%, reasons=cash_drag_with_cagr_gap
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| main | `main_rebalance_interval_fixed_interval_I1` | 31.17% | 0.00pp | -13.71% | 0.00pp | true | `target_pass_review` |
| concentrated | `concentrated_latest_champion` | 57.43% | 0.00pp | -19.78% | 0.00pp | true | `target_pass_review` |
...
- `PASS` sec_enriched_candidate_materialized_for_audit: sec_enriched_candidate_present=True; rows_with_smart_money_evidence=34731
- `PASS` alphaops_vnext_uses_sec_enriched_candidate_book: candidate_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/sec_enriched_candidate_replay/candidate_replay_book_sec_enriched.csv; rows_with_smart_money_evidence=34731
...
- `PASS` main_target_book_reaches_broker_end: selected_role=operating_target_book; target_book_max=2026-07-02; broker_end=2026-07-02; date_gap_days=0; allowed_lag_days=7; rows=1302; path=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv
- `PASS` main_operating_target_book_available: operating_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv; rows=1302; max_date=2026-07-02
- `WARN` main_historical_research_book_reaches_broker_end: historical_book_max=2026-04-30; broker_end=2026-07-02; rows=2031; operating_book_max=2026-07-02; operating_rows=1302
...
- `PASS` concentrated_target_book_reaches_broker_end: selected_role=operating_target_book; target_book_max=2026-07-02; broker_end=2026-07-02; date_gap_days=0; allowed_lag_days=7; rows=504; path=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_concentrated_target_book.csv
- `PASS` concentrated_operating_target_book_available: operating_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_concentrated_target_book.csv; rows=504; max_date=2026-07-02
- `WARN` concentrated_historical_research_book_reaches_broker_end: historical_book_max=2026-04-30; broker_end=2026-07-02; rows=23481; operating_book_max=2026-07-02; operating_rows=504
...
- `PASS` main_cash_position_count_contract: latest_date=2026-07-02; cash=5.01%; stock_count=15; crisis_state=GREEN; violations=[]; preexisting_in_baseline=[]
- `PASS` concentrated_concentration_contract: latest_date=2026-07-02; max_name=MU@30.00%; max_industry_group=Semiconductors@48.29%; group_source=industry_group; violations=[]; preexisting_in_baseline=[]

## Data Quality Update Plan

- Readiness: ready_for_fullrun=`true`, ready_for_policy_replay=`true`, blockers=[], policy_blockers=[]
- Coverage: sec_enriched_candidate_present=`true`, smart_money_rows=34731, candidate_book=`/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/sec_enriched_candidate_replay/candidate_replay_book_sec_enriched.csv`
