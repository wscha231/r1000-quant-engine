...
- Generated: 2026-07-02T23:49:28.779432+00:00
...
- Avg winner: $1,248
- Avg loser: $-666
- Total winners P&L: $837,477
- Total losers P&L: $-323,628

## MDD Window

- Peak: 2020-02-19, $126,204
- Trough: 2020-03-18, $93,366
- Drawdown: -26.02%
- Trades exited inside window: 14 (total P&L $-2,371)
...
| FTNT | $-5,349 | 2.7% | 5.2% | 20 |
| PAYC | $-5,013 | 2.7% | 5.0% | 20 |
| QRVO | $-4,940 | 2.8% | 5.5% | 20 |
| TSLA | $-4,491 | 5.2% | 6.2% | 20 |
| SHOP | $-4,478 | 4.3% | 5.9% | 20 |

## MDD Target-Book Feature Buckets

| Bucket | Linked P&L | Tickers | Avg weight | Max weight | Top tickers |
| --- | ---: | ---: | ---: | ---: | --- |
| information_technology_loss_cluster | $-30,146 | 6 | 6.5% | 12.0% | AMD, NOW, FTNT, QRVO, RNG, UI |
| weak_confirmation_weighted | $-19,428 | 3 | 9.2% | 12.0% | AMD, NOW, RNG |
| high_weight_market_leader | $-17,484 | 2 | 12.0% | 12.0% | AMD, NOW |
| negative_short_rs_weighted | $-15,760 | 3 | 6.1% | 7.0% | AMD, QRVO, UI |
| below_ma50_weighted | $-15,760 | 3 | 6.1% | 7.0% | AMD, QRVO, UI |
...
| FTNT | $-5,349 | 2020-01-31 to 2020-02-28 | 2 | 5.6% | QUALITY_COMPOUNDER | bear |
| PAYC | $-5,013 | 2020-01-31 to 2020-02-28 | 2 | 5.6% | MARKET_LEADER | bear |
| QRVO | $-4,940 | 2020-01-31 to 2020-02-28 | 2 | 5.6% | MARKET_LEADER | bear |
| TSLA | $-4,491 | 2020-01-31 to 2020-02-28 | 2 | 5.7% | MARKET_LEADER | bear |
| SHOP | $-4,478 | 2020-01-31 to 2020-02-28 | 2 | 5.6% | MARKET_LEADER | bear |

## Findings (machine-readable in findings.json)

### [HIGH] `F1_mdd_dominated_by_unrealized_holdings_main`

**Evidence**: MDD window 2020-02-19 to 2020-03-18 (-26.02% drawdown, equity loss $32,838) had only 14 round-trip exits totaling $-2,371 P&L. The drawdown is therefore dominated by unrealized loss on still-held positions (realized share 7.2%).
...
**Evidence**: 57% of total realized losses ($-184,993 of $-323,628) occurred in neutral regime, across 262 trades (avg $-706). The engine over-allocates or over-trades in this regime.
...
**Evidence**: target_exit losers average $-749 loss over 364 trades, while target_rebalance losers average $-419 over 122 trades. Explicit exits are firing too late.
...
**Evidence**: Operating target-book rows linked to MDD losers show bucket `information_technology_loss_cluster` with $-30,146 linked position P&L (41% of top context loss), 6 tickers, avg weight 6.5%, max weight 12.0%. Top tickers: AMD, NOW, FTNT, QRVO, RNG, UI.
