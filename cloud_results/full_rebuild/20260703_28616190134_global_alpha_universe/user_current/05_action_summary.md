...
- cash_policy_flag: `cash_close_to_target`
- combined_projected_cash_after_ready_orders: `12.81%`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| main | 30.61% | -26.02% | 1.130 | 26.55% | -26.79% | 0 |
| concentrated | 44.53% | -23.27% | 1.354 | 30.93% | -26.67% | 0 |
