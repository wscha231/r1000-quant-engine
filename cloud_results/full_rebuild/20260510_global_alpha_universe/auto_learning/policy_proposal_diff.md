...
+
+policy_version: "2026-05-alphaops-20260510-v1"
...
+evidence_summary:
+  main_cagr: 0.28471342512456843
+  main_sharpe: 1.6505880825201922
+  main_max_dd: -0.1542379649695953
+  main_avg_turnover_monthly: 0.5237195604954387
+  main_avg_stock_names: 24.72289156626506
+  concentrated_cagr: 0.43243153809103063
+  concentrated_sharpe: 1.7696899020615104
+  concentrated_max_dd: -0.1259120118944551
+  trade_count: 728
+  concentrated_trade_count: 207
+  combined_trade_count: 935
+  combined_win_rate: 0.5764705882352941
+  combined_avg_alpha_vs_benchmark: 0.04082303370376959
...
+    ic: -0.0575
+    n: 144
+    rationale: "IC -0.057 in bear (n=144) <= disable threshold -0.05"
+  -
+    kind: "signal_regime_disable"
+    signal: "theme_phase_multiplier_primary"
+    regime: "neutral"
...
+    ic: -0.066
+    n: 357
+    rationale: "IC -0.066 in neutral (n=357) <= disable threshold -0.05"
+sleeve_policy:
+  main_v2_balanced:
+    deep_bear:
+      core: 0.4
...
+    mandate: "main"
+    current_avg_stock_names: 24.72289156626506
...
+      cash: 0.05
+    evidence:
+      future_latest_multi_year_winner: 3.3331082815735056
+      early_latest_multi_year_winner: 0.33809850010823456
+      core_latest_multi_year_winner: 1.504147250345879
