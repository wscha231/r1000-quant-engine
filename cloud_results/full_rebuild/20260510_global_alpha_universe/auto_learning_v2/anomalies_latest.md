...
```json
{
  "concentrated_cagr": 0.43243153809103063,
  "concentrated_max_dd": -0.3903393641247158,
  "concentrated_sharpe": 1.049198723582341,
  "latest_concentrated_capacity": 0.1,
  "main_cagr": 0.20254983739282295,
  "main_max_dd": -0.3249678387996816,
  "main_sharpe": 0.9652072769745561
}
```
...
```json
{
  "main_avg_stock_names": 24.72289156626506,
  "main_avg_turnover_monthly": 0.5237195604954387,
  "main_cagr": 0.20254983739282295,
  "main_max_dd": -0.3249678387996816
}
```
...
```json
{
  "explosion_entry_n_all": 935,
  "explosion_exit_n_all": 935
}
```
