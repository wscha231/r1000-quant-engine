...
- `ai_compute_semiconductors`: score 2.26, state `emerging_leader`, 5d 4.76%, 21d 26.69%, top `AMD,QCOM,HIMX,MTSI,STM,MRVL,UMC,ARM`
- `rare_earths_battery_materials`: score 1.23, state `emerging_leader`, 5d 11.94%, 21d 18.68%, top `TECK`
- `software_ai_platforms`: score 1.06, state `neutral`, 5d 1.86%, 21d 10.76%, top `AKAM,FTNT,ORCL,CRWD,PANW,GEN,RBRK,CDNS`
- `optical_networking_ai_infra`: score 0.56, state `emerging_leader`, 5d 1.75%, 21d 12.46%, top `COHR,CIEN,LITE`
- `software`: score 0.35, state `neutral`, 5d 0.41%, 21d 0.15%, top `FLEX,GLW,HPE,HPQ,GOOGL,AMZN,AAPL,CSCO`
- `industrial`: score 0.08, state `neutral`, 5d -0.60%, 21d 0.97%, top `AAON,BE,VRT,ECG,FIX,ROK,CAT,MTZ`
- `consumer`: score 0.06, state `neutral`, 5d -0.40%, 21d -1.39%, top `TSLA,MNST,PRMB,HRB,TXRH,BWA,SFM,HST`
- `banking`: score -0.07, state `neutral`, 5d -0.82%, 21d 1.06%, top `CBOE,APO,ARES,BEN,MS,IVZ,JEF,BLK`
- `space_launch`: score -0.12, state `neutral`, 5d 2.37%, 21d -2.96%, top `RKLB,HWM,BA,FTAI,HEI,AXON,HXL,GE`
...
- `MRVL` MARVELL TECHNOLOGY INC: theme `ai_compute_semiconductors`, 1d 6.32%, 5d 3.14%, 21d 41.93%, score 2.71
- `UMC` United Microelectronics: theme `ai_compute_semiconductors`, 1d 1.72%, 5d 18.16%, 21d 61.80%, score 2.68
- `CRWD` CROWDSTRIKE HOLDINGS INC CLASS A: theme `software_ai_platforms`, 1d 4.36%, 5d 15.83%, 21d 33.72%, score 2.66
...
- `MRVL` via `SOXX`/semiconductors_broad: ETF attention 1.62, ticker score 2.71, 5d 3.14%, in universe `True`
- `MRVL` via `XSD`/semiconductors_equal_weight: ETF attention 1.36, ticker score 2.71, 5d 3.14%, in universe `True`
