...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| main | 35.21% | 30.00% | 0.00pp | -41.43% | -20.00% | 21.43pp | false |
| concentrated | 25.73% | 50.00% | 24.27pp | -62.51% | -25.00% | 37.51pp | false |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| main | `main_rebalance_interval_fixed_interval_I1` | 32.13% | 0.00pp | -16.69% | 0.00pp | true | `target_pass_review` |
| concentrated | `concentrated_grid_N3_score_power_I1` | 47.89% | 2.11pp | -21.45% | 0.00pp | false | `needs_alpha_boost` |
...
- `WARN` main_historical_research_book_reaches_broker_end: historical_book_max=2026-02-27; broker_end=2026-06-01; rows=2245; operating_book_max=2026-06-01; operating_rows=1330
...
- `WARN` concentrated_historical_research_book_reaches_broker_end: historical_book_max=2026-02-27; broker_end=2026-06-01; rows=22941; operating_book_max=2026-06-01; operating_rows=494
...
- `WARN` concentrated_replay_filter_matches_latest_target: broker_filter_n=missing; latest_target_n=3; broker_mode=missing; latest_mode=winner_take_all
