...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| main | 34.33% | 35.00% | 0.67pp | -25.93% | -25.00% | 0.93pp | false |
| concentrated | 44.57% | 50.00% | 5.43pp | -25.88% | -25.00% | 0.88pp | false |
...
- `main`: severity=`warn`, avg_cash=26.79%, latest_cash=16.09%, reasons=cash_drag_with_cagr_gap
- `concentrated`: severity=`warn`, avg_cash=42.37%, latest_cash=6.55%, reasons=cash_drag_with_cagr_gap
...
| concentrated | `concentrated_broker_ledger_replay` | 44.57% | 5.43pp | -25.88% | 0.88pp | false | `blocked_both` |
...
- `PASS` main_target_book_reaches_broker_end: selected_role=operating_target_book; target_book_max=2026-06-12; broker_end=2026-06-12; date_gap_days=0; allowed_lag_days=7; rows=1280; path=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv
- `PASS` main_operating_target_book_available: operating_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv; rows=1280; max_date=2026-06-12
- `WARN` main_historical_research_book_reaches_broker_end: historical_book_max=2026-03-31; broker_end=2026-06-12; rows=1445; operating_book_max=2026-06-12; operating_rows=1280
...
- `WARN` concentrated_historical_research_book_reaches_broker_end: historical_book_max=2026-03-31; broker_end=2026-06-12; rows=23208; operating_book_max=2026-06-12; operating_rows=497
...
- `PASS` main_current_position_count_near_latest_target_count: main_positions=13; latest_target_rows=15; excess=0
...
- `PASS` main_cash_position_count_contract: latest_date=2026-06-12; cash=19.22%; stock_count=13; crisis_state=GREEN; violations=[]; preexisting_in_baseline=[]
- `PASS` concentrated_concentration_contract: latest_date=2026-06-12; max_name=SNDK@28.50%; max_industry_group=Tech Hardware & Storage@45.09%; group_source=industry_group; violations=[]; preexisting_in_baseline=[]
