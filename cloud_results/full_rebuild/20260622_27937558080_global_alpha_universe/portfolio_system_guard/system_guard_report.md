...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| main | 34.71% | 30.00% | 0.00pp | -26.03% | -25.00% | 1.03pp | false |
| concentrated | 44.35% | 50.00% | 5.65pp | -24.70% | -28.00% | 0.00pp | false |
...
- `main`: severity=`ok`, avg_cash=26.59%, latest_cash=14.89%, reasons=none
- `concentrated`: severity=`warn`, avg_cash=41.94%, latest_cash=5.76%, reasons=cash_drag_with_cagr_gap
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| main | `main_rebalance_interval_fixed_interval_I1` | 34.14% | 0.00pp | -14.06% | 0.00pp | true | `target_pass_review` |
| concentrated | `concentrated_latest_champion` | 53.89% | 0.00pp | -19.32% | 0.00pp | true | `target_pass_review` |
...
- `PASS` main_target_book_reaches_broker_end: selected_role=operating_target_book; target_book_max=2026-06-18; broker_end=2026-06-18; date_gap_days=0; allowed_lag_days=7; rows=1269; path=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv
- `PASS` main_operating_target_book_available: operating_book=/home/runner/work/r1000-quant-engine/r1000-quant-engine/outputs/reports/operating_main_target_book.csv; rows=1269; max_date=2026-06-18
- `WARN` main_historical_research_book_reaches_broker_end: historical_book_max=2026-03-31; broker_end=2026-06-18; rows=2190; operating_book_max=2026-06-18; operating_rows=1269
...
- `WARN` concentrated_historical_research_book_reaches_broker_end: historical_book_max=2026-03-31; broker_end=2026-06-18; rows=23160; operating_book_max=2026-06-18; operating_rows=490
