...
- Generated: 2026-06-22T11:09:40.668304+00:00
...
- Avg winner: $1,143
- Avg loser: $-651
- Total winners P&L: $737,327
- Total losers P&L: $-314,390

## MDD Window

- Peak: 2020-02-19, $127,680
- Trough: 2020-03-18, $94,446
- Drawdown: -26.03%
- Trades exited inside window: 14 (total P&L $-1,933)
...
| --- | ---: | ---: | ---: | ---: | --- |
| information_technology_loss_cluster | $-30,263 | 6 | 6.5% | 12.0% | AMD, NOW, FTNT, QRVO, RNG, UI |
...
| PENN | $-7,419 | 2020-01-31 to 2020-02-28 | 2 | 5.6% | MARKET_LEADER | bear |
...
**Evidence**: MDD window 2020-02-19 to 2020-03-18 (-26.03% drawdown, equity loss $33,234) had only 14 round-trip exits totaling $-1,933 P&L. The drawdown is therefore dominated by unrealized loss on still-held positions (realized share 5.8%).
...
**Evidence**: 55% of total realized losses ($-174,141 of $-314,390) occurred in neutral regime, across 256 trades (avg $-680). The engine over-allocates or over-trades in this regime.
...
**Evidence**: target_exit losers average $-721 loss over 364 trades, while target_rebalance losers average $-436 over 119 trades. Explicit exits are firing too late.
...
**Evidence**: Operating target-book rows linked to MDD losers show bucket `information_technology_loss_cluster` with $-30,263 linked position P&L (41% of top context loss), 6 tickers, avg weight 6.5%, max weight 12.0%. Top tickers: AMD, NOW, FTNT, QRVO, RNG, UI.
