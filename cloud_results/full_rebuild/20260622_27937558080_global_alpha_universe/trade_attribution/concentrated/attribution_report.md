...
- Generated: 2026-06-22T11:09:40.938068+00:00
...
- Avg winner: $4,736
- Avg loser: $-1,328
- Total winners P&L: $1,013,460
- Total losers P&L: $-233,729

## MDD Window

- Peak: 2021-09-03, $226,203
- Trough: 2023-08-17, $170,334
- Drawdown: -24.70%
- Trades exited inside window: 101 (total P&L $-26,805)
...
| DDOG | $-31,577 | 14.9% | 22.3% | 82 |
| NVDA | $-30,370 | 5.6% | 7.9% | 42 |
| BLD | $-23,064 | 13.5% | 21.7% | 41 |
| TSLA | $-18,079 | 7.4% | 8.1% | 43 |
| ORLY | $-15,078 | 5.8% | 10.1% | 41 |
| STLD | $-13,262 | 1.6% | 2.3% | 42 |
| DXCM | $-12,596 | 12.9% | 16.9% | 42 |
| MA | $-12,457 | 4.7% | 11.0% | 123 |
| MLI | $-11,812 | 7.4% | 10.8% | 42 |

## MDD Target-Book Feature Buckets

| Bucket | Linked P&L | Tickers | Avg weight | Max weight | Top tickers |
| --- | ---: | ---: | ---: | ---: | --- |
| weak_confirmation_weighted | $-257,249 | 17 | 12.6% | 30.0% | BILL, DDOG, NVDA, BLD, TSLA, ORLY, DXCM, MA |
| high_weight_market_leader | $-166,937 | 13 | 17.0% | 30.0% | BILL, DDOG, TSLA, DXCM, XPO, NTLA, MRNA, ON |
| information_technology_loss_cluster | $-132,579 | 8 | 13.1% | 30.0% | BILL, DDOG, NVDA, ON, ONTO, NET, MSI, JBL |
| qqq_underperforms_spy_weighted | $-123,506 | 13 | 12.1% | 28.5% | DDOG, BLD, ORLY, DXCM, MA, XPO, MRNA, LOPE |
| negative_short_rs_weighted | $-70,387 | 6 | 9.3% | 20.0% | NVDA, BLD, ORLY, TXRH, JBL, CHE |
...
| DDOG | $-31,577 | 2021-08-31 to 2021-11-30 | 4 | 19.3% | MARKET_LEADER | neutral |
| NVDA | $-30,370 | 2021-11-30 to 2021-12-31 | 2 | 7.6% | MARKET_LEADER | bull |
...
| ORLY | $-15,078 | 2022-11-30 to 2022-12-30 | 2 | 9.8% | QUALITY_COMPOUNDER | bear |
...
| MLI | $-11,812 | 2023-02-28 to 2023-03-31 | 2 | 10.7% | MARKET_LEADER | bull |

## Findings (machine-readable in findings.json)

### [MEDIUM] `F3_target_exit_losers_deeper_than_rebalance_concentrated`

**Evidence**: target_exit losers average $-1,397 loss over 129 trades, while target_rebalance losers average $-1,139 over 47 trades. Explicit exits are firing too late.
...
**Evidence**: Operating target-book rows linked to MDD losers show bucket `weak_confirmation_weighted` with $-257,249 linked position P&L (87% of top context loss), 17 tickers, avg weight 12.6%, max weight 30.0%. Top tickers: BILL, DDOG, NVDA, BLD, TSLA, ORLY, DXCM, MA, MLI, XPO, MRNA, WCC.
