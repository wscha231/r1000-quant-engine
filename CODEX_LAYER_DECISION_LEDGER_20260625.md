...
| Right-tail entry/capture audit | Run `28074476465` top open winners had PIT-visible entry signals: Main 5/5 and Concentrated 5/5 skill-evidence flags. But capture was fragmented: Main top-5 avg presence blocks 3.2 with 31 sells; Concentrated avg presence blocks 2.2 with 15 sells. | Keep as diagnostic and sidecar artifact. | Next lever should target fragmented capture of already-identified winners, not broad exposure, broad persistence, or broad replacement acceleration. |
