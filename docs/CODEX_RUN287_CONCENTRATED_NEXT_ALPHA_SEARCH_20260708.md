...
- `outputs/run287_conc_next_alpha_search/summary.json`
- `outputs/run287_conc_next_alpha_search/arm_metrics.csv`
- `outputs/run287_conc_next_alpha_search/data_availability.json`
- `outputs/run287_conc_next_alpha_search/report.md`
