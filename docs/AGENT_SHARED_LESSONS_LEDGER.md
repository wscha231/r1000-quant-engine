...
- Result:
  ...
  - Strict numeric-guidance candidates: 17 filings and 42 passage rows across
...
- Next action:
  - Manually review the 17 candidate filings and build the EPS/revenue range,
    fiscal-period, currency, unit, and prior-guidance pairing parser.
