            ...
            defensive_rows.append(
                {
                    ...
                    "style_cash_defense_preference": row.get("style_cash_defense_preference", ""),
                    "style_row_breakout_fit": row.get("style_row_breakout_fit", ""),
                    "style_row_turnaround_fit": row.get("style_row_turnaround_fit", ""),
                    "score": row.get("score", ""),
