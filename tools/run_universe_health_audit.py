...
def build_payload(args: argparse.Namespace) -> dict[str, Any]:
    ...
    payload = {
        ...
        "promotion_allowed_scope": "universe_substrate_health_only",
        ...
        "rules": {
            ...
            "promotion_allowed_semantics": "promotion_allowed=true means only the universe substrate gate passed; it does not authorize strategy promotion, production sync, workflow dispatch, or trading",
