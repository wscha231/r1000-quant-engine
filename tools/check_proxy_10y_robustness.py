...
def classify_proxy_10y_robustness(latest_run: str | Path) -> dict[str, Any]:
    ...
    checks: dict[str, bool] = {
        ...
        "proxy_10y_universe_canonical_sync_disabled": universe_substrate.get("canonical_production_sync") is False,
        "proxy_10y_universe_promotion_disabled": universe_substrate.get("promotion_allowed") is False,
        "proxy_10y_universe_production_promotion_disabled": universe_substrate.get("production_promotion_allowed") is False,
...
def render_report(payload: dict[str, Any]) -> str:
    lines = [
        ...
        f"- production promotion allowed: `{payload.get('production_promotion_allowed')}`",
        "",
        "## Checks",
        "",
        "| Check | Pass |",
