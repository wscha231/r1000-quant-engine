...
STYLE_WEIGHTS: dict[str, dict[str, float]] = {
    ...
    "sec_evidence_shadow": {
        "leader_onset_sec_v3_score": 0.28,
        "leader_onset_sec_v2_score": 0.14,
        "portfolio_future_winner_engine_score": 0.18,
        "selection_market_confirmation_score": 0.13,
        "sec_combined_evidence_score": 0.12,
        "institutional_evidence_score": 0.06,
        "early_evidence_score": 0.05,
        "rs_acceleration_score": 0.08,
        "entry_quality_score": 0.04,
        "industry_group_strength_score": 0.02,
    },
    "sec_support_overlay": {
        "leader_onset_sec_v4_support_score": 0.30,
        "leader_onset_score": 0.18,
        "portfolio_future_winner_engine_score": 0.18,
        "selection_market_confirmation_score": 0.12,
        "sec_support_boost_score": 0.08,
        "institutional_evidence_score": 0.04,
        "early_evidence_score": 0.03,
            ...
            rows.append(
                {
                    ...
                    "leader_onset_sec_v4_support_score": safe_float(row.get("leader_onset_sec_v4_support_score")),
                    ...
                    "sec_support_boost_score": safe_float(row.get("sec_support_boost_score")),
                    "sec_form4_net_buy_score": safe_float(row.get("sec_form4_net_buy_score")),
                    "sec_form4_sale_risk_score": safe_float(row.get("sec_form4_sale_risk_score")),
                    ...
                    "sec_13f_breadth_score": safe_float(row.get("sec_13f_breadth_score")),
