...
Initial implementation supports `E0_baseline_latest` as a normalized baseline
artifact run. Non-control experiments intentionally emit failure reports until
their strategy adapters are implemented.
"""
