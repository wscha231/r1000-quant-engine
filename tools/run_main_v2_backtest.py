            ...
            holding_rows.append(
                {
                    ...
                    "theme_event_risk_sensitivity_max": source.get("theme_event_risk_sensitivity_max", ""),
                    "theme_structural_growth_primary": source.get("theme_structural_growth_primary", ""),
                    "theme_structural_growth_max": source.get("theme_structural_growth_max", ""),
                    "market_style_regime_label": source.get("market_style_regime_label", ""),
                    "style_breakout_preference": source.get("style_breakout_preference", ""),
                    "style_turnaround_preference": source.get("style_turnaround_preference", ""),
                    "style_quality_compounder_preference": source.get("style_quality_compounder_preference", ""),
                    "style_cash_defense_preference": source.get("style_cash_defense_preference", ""),
                    "style_row_breakout_fit": source.get("style_row_breakout_fit", ""),
                    "style_row_turnaround_fit": source.get("style_row_turnaround_fit", ""),
                    "style_row_compounder_fit": source.get("style_row_compounder_fit", ""),
