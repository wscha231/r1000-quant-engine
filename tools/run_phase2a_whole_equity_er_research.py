#!/usr/bin/env python3
"""Bind a verified whole-US-equity cohort to existing Run287 gross research ER outputs.
...
SCHEMA_VERSION = "phase2a-whole-equity-er-research-v2"
CONTRACT_SCHEMA = "phase2a-whole-equity-er-research-contract-v2"
...
OVERALL_READY = "READY_WHOLE_EQUITY_GROSS_RESEARCH_ER_1_3_6M"
OVERALL_PARTIAL = "PARTIAL_BLOCKED_WHOLE_EQUITY_GROSS_RESEARCH_ER"
...
def build_output(
        ...
        rows.append(
            {
                ...
                "status": row_status,
                "gross_research_expected_return_1m": horizons["1m"]["expected_return"],
                "gross_research_expected_return_3m": horizons["3m"]["expected_return"],
                "gross_research_expected_return_6m": horizons["6m"]["expected_return"],
                "gross_research_expected_return_12m": None,
                "gross_research_benchmark_expected_return_1m": horizons["1m"].get("benchmark_expected_return"),
                "gross_research_benchmark_expected_return_3m": horizons["3m"].get("benchmark_expected_return"),
                "gross_research_benchmark_expected_return_6m": horizons["6m"].get("benchmark_expected_return"),
                "gross_research_benchmark_expected_return_12m": None,
                "gross_research_expected_alpha_1m": horizons["1m"]["expected_alpha"],
                "gross_research_expected_alpha_3m": horizons["3m"]["expected_alpha"],
                "gross_research_expected_alpha_6m": horizons["6m"]["expected_alpha"],
                "gross_research_expected_alpha_12m": None,
    ...
    output: dict[str, Any] = {
        ...
        "whole_equity_gross_research_er_ready_1_3_6m": whole_ready,
        "artifact_kind": "GROSS_RESEARCH_ER_EVIDENCE",
        "validation_status": "RESEARCH_FIT_OUTPUT_NOT_A3_WALK_FORWARD_VALIDATED",
        "net_of_costs": False,
        "a3_validated_er_eligible": False,
        "er_promotion_gate_status": "BLOCKED_GROSS_RESEARCH_ONLY",
        "promotion_blockers": [
            "BLOCKED_NOT_A3_WALK_FORWARD_VALIDATED",
            "BLOCKED_NOT_NET_OF_COSTS",
            TWELVE_MONTH_BLOCKER,
            DOWNSIDE_CALIBRATION_BLOCKER,
            "BLOCKED_EXPECTED_DRAWDOWN_NOT_VALIDATED",
            "BLOCKED_SIGNAL_CONFIDENCE_NOT_CALIBRATED",
        ],
        "expected_return_12m_status": TWELVE_MONTH_BLOCKER,
        "expected_drawdown_status": "BLOCKED_EXPECTED_DRAWDOWN_NOT_VALIDATED",
        "signal_confidence_status": "BLOCKED_SIGNAL_CONFIDENCE_NOT_CALIBRATED",
        "downside_probability_status": DOWNSIDE_CALIBRATION_BLOCKER,
        "gross_research_expected_alpha_basis": "GROSS_BENCHMARK_EXCESS_RESEARCH_NOT_AFTER_COSTS",
        "raw_challenger_expected_alpha_basis": "0.7_BENCHMARK_EXCESS_PLUS_0.3_SECTOR_NEUTRAL",
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--contract", default="docs/phase2a_whole_equity_er_research_contract.json")
        ...
        json.dumps(
            {
                ...
                "whole_equity_gross_research_er_ready_1_3_6m": result["whole_equity_gross_research_er_ready_1_3_6m"],
                "expected_return_12m_status": result["expected_return_12m_status"],
            },
            sort_keys=True,
        )
    )
    return 0 if result["whole_equity_gross_research_er_ready_1_3_6m"] else 2
