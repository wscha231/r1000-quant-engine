...
def classify_pre_broker_substrate(latest_run: str | Path, *, universe_mode: str = "global_alpha_universe") -> dict[str, Any]:
    ...
    return {
        ...
        "promotion_allowed_scope": "pre_broker_substrate_gate_only",
        ...
        "rules": {
            ...
            "promotion_allowed_semantics": "promotion_allowed=false always; broker_replay_allowed=true only means the substrate is clean enough to run broker-ledger mechanics",
        },
    }
