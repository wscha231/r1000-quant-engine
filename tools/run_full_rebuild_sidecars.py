...
python tools/run_alphaops_operating_cadence_status.py --latest-run outputs --output-dir outputs/operating_cadence_status 2>&1 | tee outputs/full_rebuild_logs/operating_cadence_status.log || true
python tools/run_rs_2w_entry_timing_screen.py --target-book outputs/alphaops_vnext/official_concentrated_target_book.csv --price-cache cache_prices --output-dir outputs/rs_2w_entry_timing_screen 2>&1 | tee outputs/full_rebuild_logs/rs_2w_entry_timing_screen.log || true
python tools/run_oos_lock_audit.py --latest-run outputs --output-dir outputs/oos_lock --config research/oos_lock.yaml 2>&1 | tee outputs/full_rebuild_logs/oos_lock.log || true
run_cash_contract_validator
run_metric_hygiene_report
