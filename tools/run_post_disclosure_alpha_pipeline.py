...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--styles", default="future_heavy,future_heavy_post_disclosure_confirmed,future_heavy_post_disclosure_micro,post_disclosure_price_confirmed,monster_heavy,post_disclosure_tiebreaker,post_disclosure_discovery,post_disclosure_mega_confirmation,post_disclosure_light,post_disclosure_balanced")
