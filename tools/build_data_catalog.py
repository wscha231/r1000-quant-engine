...
DATASETS: list[dict[str, Any]] = [
    ...
    {"name": "top_manager_follow_events", "path": "data_pit/sec/top_manager_13f_follow_events.parquet",
     "kind": "parquet", "ticker_col": "ticker", "date_col": "available_from_ts",
     "layer": "top7", "owner_workflow": "post_disclosure_alpha_pipeline.yml", "cadence_days": 100},
    {"name": "top_manager_discovery_signals", "path": "data_pit/sec/top_manager_discovery_signals.parquet",
     "kind": "parquet", "ticker_col": "ticker", "date_col": "rebalance_date",
     "layer": "top7", "owner_workflow": "full_rebuild_manual.yml", "cadence_days": 40},
    ...
    {"name": "fmp_earnings_calendar_history", "path": "data_pit/events/earnings_calendar_history.parquet",
