...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    payload = {
        ...
        "measured_research_7y_candidate_count": sum(1 for row in candidate_rows if row.get("decision") == "measured_research_7y"),
        "do_not_use_candidate_count": sum(1 for row in candidate_rows if row.get("decision") == "do_not_use_evidence_tier"),
        "production_activation_allowed": False,
