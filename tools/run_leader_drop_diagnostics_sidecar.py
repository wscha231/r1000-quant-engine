        ...
        rows.append(
            {
                ...
                "evidence_fusion_score": row.get("evidence_fusion_score", ""),
                "sec_form4_score": row.get("sec_form4_score", ""),
                "sec_13f_score": row.get("sec_13f_score", ""),
                "etf_holdings_score_shadow": row.get("etf_holdings_score_shadow", ""),
                "early_evidence_score": row.get("early_evidence_score", ""),
                "institutional_evidence_score": row.get("institutional_evidence_score", ""),
                "etf_holdings_score": row.get("etf_holdings_score", ""),
