...
DEFAULT_TESTS: list[tuple[str, list[str]]] = [
    ...
    ("tests/evidence_policy_smoke.py", []),
    ("tests/clean_7y_research_readiness_smoke.py", []),
    ("tests/pre_broker_substrate_gate_smoke.py", []),
    ...
    ("tests/universe_recovery_candidate_smoke.py", []),
    ("tests/universe_recovery_candidate_readiness_smoke.py", []),
