...
DEFAULT_TESTS: list[tuple[str, list[str]]] = [
    ...
    ("tests/target_book_control_repro_audit_smoke.py", []),
    ("tests/catboost_task_type_smoke.py", []),
    ...
    ("tests/target_generation_substrate_archive_smoke.py", []),
    ...
    ("tests/rs_timing_tiebreaker_broker_ab_smoke.py", []),
    ...
    ("tests/free_data_lake_bootstrap_required_tickers_smoke.py", []),
    ...
    ("tests/latest_price_date_audit_extra_tickers_smoke.py", []),
    ...
    ("tests/official_book_bull_floor_broker_ab_smoke.py", []),
    ...
    ("tests/main_hedge_off_baseline_replay_smoke.py", []),
    ("tests/run239_postmortem_smoke.py", []),
    ("tests/ai_capex_taxonomy_smoke.py", []),
    ("tests/ai_capex_candidate_enrichment_smoke.py", []),
    ("tests/earnings_revision_feed_contract_smoke.py", []),
    ("tests/earnings_revision_signals_smoke.py", []),
    ("tests/earnings_data_inventory_smoke.py", []),
    ("tests/earnings_guidance_coverage_tiers_smoke.py", []),
    ("tests/sec_actuals_not_coverage_smoke.py", []),
    ...
    ("tests/run287_actual_results_rolling_review_smoke.py", []),
    ...
    ("tests/alphaops_governance_smoke.py", []),
    ...
    ("tests/ai_capex_tilt_broker_ab_smoke.py", []),
    ...
    ("tests/fixed_book_cashfunded_early_entry_ab_smoke.py", []),
    ...
    ("tests/regime_nowcast_macro_cache_coverage_smoke.py", []),
    ("tests/regime_nowcast_earnings_guidance_coverage_smoke.py", []),
    ...
    ("tests/state_override_service_forbidden_smoke.py", []),
    ("tests/state_conditional_ic_audit_smoke.py", []),
    ("tests/state_conditional_ic_era_gate_smoke.py", []),
    ...
    ("tests/user_current_preview_contract_smoke.py", []),
