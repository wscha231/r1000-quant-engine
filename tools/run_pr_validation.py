...
DEFAULT_TESTS: list[tuple[str, list[str]]] = [
    ...
    ("tests/main_v4_future_winner_evidence_smoke.py", []),
    ("tests/concentrated_v3_broker_selected_leaders_smoke.py", []),
    ("tests/hold_vs_replace_audit_smoke.py", []),
    ...
    ("tests/sec_form4_merge_shards_smoke.py", []),
    ("tests/sec_edgar_form4_refresh_workflow_smoke.py", []),
    ("tests/fast_replay_official_freshness_smoke.py", []),
